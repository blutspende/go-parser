...
type CCM_I21_APPOINTMENT_HISTORY_RESOURCES_RESOURCE_DETAIL struct {
	Resource_object CCM_I21_APPOINTMENT_HISTORY_RESOURCES_RESOURCE_DETAIL_RESOURCE_OBJECT `hl7:"GROUP"`
	Resource_observation []CCM_I21_APPOINTMENT_HISTORY_RESOURCES_RESOURCE_DETAIL_RESOURCE_OBSERVATION `hl7:"GROUP;ATR=optional"`
}

// CCM_I21_APPOINTMENT_HISTORY_RESOURCES_RESOURCE_DETAIL_RESOURCE_OBJECT - Group struct
type CCM_I21_APPOINTMENT_HISTORY_RESOURCES_RESOURCE_DETAIL_RESOURCE_OBJECT struct {
...
// CCM_I21_APPOINTMENT_HISTORY_RESOURCES_RESOURCE_DETAIL_RESOURCE_OBSERVATION - Group struct
type CCM_I21_APPOINTMENT_HISTORY_RESOURCES_RESOURCE_DETAIL_RESOURCE_OBSERVATION struct {
...
type CCM_I21_CLINICAL_HISTORY_CLINICAL_HISTORY_DETAIL struct {
	Clinical_history_object CCM_I21_CLINICAL_HISTORY_CLINICAL_HISTORY_DETAIL_CLINICAL_HISTORY_OBJECT `hl7:"GROUP"`
	Clinical_history_observation []CCM_I21_CLINICAL_HISTORY_CLINICAL_HISTORY_DETAIL_CLINICAL_HISTORY_OBSERVATION `hl7:"GROUP;ATR=optional"`
}

// CCM_I21_CLINICAL_HISTORY_CLINICAL_HISTORY_DETAIL_CLINICAL_HISTORY_OBJECT - Group struct
type CCM_I21_CLINICAL_HISTORY_CLINICAL_HISTORY_DETAIL_CLINICAL_HISTORY_OBJECT struct {
...
// CCM_I21_CLINICAL_HISTORY_CLINICAL_HISTORY_DETAIL_CLINICAL_HISTORY_OBSERVATION - Group struct
type CCM_I21_CLINICAL_HISTORY_CLINICAL_HISTORY_DETAIL_CLINICAL_HISTORY_OBSERVATION struct {
	ObservationResult []OBX `hl7:"TAG=OBX;ATR=optional"`
	ParticipationInformation []PRT `hl7:"TAG=PRT;ATR=optional"`
}
...
type CCM_I21_CLINICAL_HISTORY_ROLE_CLINICAL_HISTORY struct {
	Role_clinical_history_object CCM_I21_CLINICAL_HISTORY_ROLE_CLINICAL_HISTORY_ROLE_CLINICAL_HISTORY_OBJECT `hl7:"GROUP"`
	Variance []VAR `hl7:"TAG=VAR;ATR=optional"`
}

// CCM_I21_CLINICAL_HISTORY_ROLE_CLINICAL_HISTORY_ROLE_CLINICAL_HISTORY_OBJECT - Group struct
type CCM_I21_CLINICAL_HISTORY_ROLE_CLINICAL_HISTORY_ROLE_CLINICAL_HISTORY_OBJECT struct {
...
type CCM_I21_MEDICATION_HISTORY_MEDICATION_ORDER_DETAIL struct {
	...
	Medication_order_observation []CCM_I21_MEDICATION_HISTORY_MEDICATION_ORDER_DETAIL_MEDICATION_ORDER_OBSERVATION `hl7:"GROUP;ATR=optional"`
}

// CCM_I21_MEDICATION_HISTORY_MEDICATION_ORDER_DETAIL_MEDICATION_ORDER_OBSERVATION - Group struct
type CCM_I21_MEDICATION_HISTORY_MEDICATION_ORDER_DETAIL_MEDICATION_ORDER_OBSERVATION struct {
	ObservationResult []OBX `hl7:"TAG=OBX;ATR=optional"`
	ParticipationInformation []PRT `hl7:"TAG=PRT;ATR=optional"`
}
...
type CCM_I21_MEDICATION_HISTORY_MEDICATION_ENCODING_DETAIL struct {
	...
	PharmacyTreatmentRoute []RXR `hl7:"TAG=RXR"`
	PharmacyTreatmentComponentOrder []RXC `hl7:"TAG=RXC;ATR=optional"`
	Medication_encoding_observation []CCM_I21_MEDICATION_HISTORY_MEDICATION_ENCODING_DETAIL_MEDICATION_ENCODING_OBSERVATION `hl7:"GROUP;ATR=optional"`
}

// CCM_I21_MEDICATION_HISTORY_MEDICATION_ENCODING_DETAIL_MEDICATION_ENCODING_OBSERVATION - Group struct
type CCM_I21_MEDICATION_HISTORY_MEDICATION_ENCODING_DETAIL_MEDICATION_ENCODING_OBSERVATION struct {
	ObservationResult []OBX `hl7:"TAG=OBX;ATR=optional"`
	ParticipationInformation []PRT `hl7:"TAG=PRT;ATR=optional"`
}
...
type CCM_I21_MEDICATION_HISTORY_MEDICATION_ADMINISTRATION_DETAIL struct {
	...
	PharmacyTreatmentRoute RXR `hl7:"TAG=RXR"`
	ObservationResult []OBX `hl7:"TAG=OBX;ATR=optional"`
	Medication_administration_observation []CCM_I21_MEDICATION_HISTORY_MEDICATION_ADMINISTRATION_DETAIL_MEDICATION_ADMINISTRATION_OBSERVATION `hl7:"GROUP;ATR=optional"`
}

// CCM_I21_MEDICATION_HISTORY_MEDICATION_ADMINISTRATION_DETAIL_MEDICATION_ADMINISTRATION_OBSERVATION - Group struct
type CCM_I21_MEDICATION_HISTORY_MEDICATION_ADMINISTRATION_DETAIL_MEDICATION_ADMINISTRATION_OBSERVATION struct {
	ObservationResult []OBX `hl7:"TAG=OBX;ATR=optional"`
	ParticipationInformation []PRT `hl7:"TAG=PRT;ATR=optional"`
}
...
type CCM_I21_PROBLEM struct {
	...
	Problem_observation []CCM_I21_PROBLEM_PROBLEM_OBSERVATION `hl7:"GROUP;ATR=optional"`
}

// CCM_I21_PROBLEM_ROLE_PROBLEM - Group struct
type CCM_I21_PROBLEM_ROLE_PROBLEM struct {
	Role_problem_object CCM_I21_PROBLEM_ROLE_PROBLEM_ROLE_PROBLEM_OBJECT `hl7:"GROUP"`
	Variance []VAR `hl7:"TAG=VAR;ATR=optional"`
}

// CCM_I21_PROBLEM_ROLE_PROBLEM_ROLE_PROBLEM_OBJECT - Group struct
type CCM_I21_PROBLEM_ROLE_PROBLEM_ROLE_PROBLEM_OBJECT struct {
	Role ROL `hl7:"TAG=ROL;ATR=optional"`
	ProviderData PRD `hl7:"TAG=PRD;ATR=optional"`
}

// CCM_I21_PROBLEM_PROBLEM_OBSERVATION - Group struct
type CCM_I21_PROBLEM_PROBLEM_OBSERVATION struct {
	ObservationResult []OBX `hl7:"TAG=OBX;ATR=optional"`
	ParticipationInformation []PRT `hl7:"TAG=PRT;ATR=optional"`
}
...
type CCM_I21_GOAL struct {
	...
	Goal_observation []CCM_I21_GOAL_GOAL_OBSERVATION `hl7:"GROUP;ATR=optional"`
}

// CCM_I21_GOAL_ROLE_GOAL - Group struct
type CCM_I21_GOAL_ROLE_GOAL struct {
	Role_goal_object CCM_I21_GOAL_ROLE_GOAL_ROLE_GOAL_OBJECT `hl7:"GROUP"`
	Variance []VAR `hl7:"TAG=VAR;ATR=optional"`
}

// CCM_I21_GOAL_ROLE_GOAL_ROLE_GOAL_OBJECT - Group struct
type CCM_I21_GOAL_ROLE_GOAL_ROLE_GOAL_OBJECT struct {
	Role ROL `hl7:"TAG=ROL;ATR=optional"`
	ProviderData PRD `hl7:"TAG=PRD;ATR=optional"`
}

// CCM_I21_GOAL_GOAL_OBSERVATION - Group struct
type CCM_I21_GOAL_GOAL_OBSERVATION struct {
	ObservationResult []OBX `hl7:"TAG=OBX;ATR=optional"`
	ParticipationInformation []PRT `hl7:"TAG=PRT;ATR=optional"`
}
...
type CCM_I21_PATHWAY struct {
	...
	Pathway_observation []CCM_I21_PATHWAY_PATHWAY_OBSERVATION `hl7:"GROUP;ATR=optional"`
}

// CCM_I21_PATHWAY_ROLE_PATHWAY - Group struct
type CCM_I21_PATHWAY_ROLE_PATHWAY struct {
	Role_pathway_object CCM_I21_PATHWAY_ROLE_PATHWAY_ROLE_PATHWAY_OBJECT `hl7:"GROUP"`
	Variance []VAR `hl7:"TAG=VAR;ATR=optional"`
}

// CCM_I21_PATHWAY_ROLE_PATHWAY_ROLE_PATHWAY_OBJECT - Group struct
type CCM_I21_PATHWAY_ROLE_PATHWAY_ROLE_PATHWAY_OBJECT struct {
	Role ROL `hl7:"TAG=ROL;ATR=optional"`
	ProviderData PRD `hl7:"TAG=PRD;ATR=optional"`
}

// CCM_I21_PATHWAY_PATHWAY_OBSERVATION - Group struct
type CCM_I21_PATHWAY_PATHWAY_OBSERVATION struct {
	ObservationResult []OBX `hl7:"TAG=OBX;ATR=optional"`
	ParticipationInformation []PRT `hl7:"TAG=PRT;ATR=optional"`
}

// CCM_I21 - Collaborative Care Message
// https://hl7-definition.caristix.com/v2/HL7v2.8/TriggerEvents/CCM_I21
type CCM_I21 struct {
