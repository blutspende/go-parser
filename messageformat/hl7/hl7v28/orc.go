...
// ORC - Common Order
// https://hl7-definition.caristix.com/v2/HL7v2.8/Segments/ORC
type ORC struct {
	...
	OrderControlCodeReason CWE `hl7:"POS=17"`
	EnteringOrganization CWE `hl7:"POS=18"`
	EnteringDevice CWE `hl7:"POS=19"`
	ActionBy []XCN `hl7:"POS=20"`
	AdvancedBeneficiaryNoticeCode CWE `hl7:"POS=21"`
	...
	AdvancedBeneficiaryNoticeDate time.Time `hl7:"POS=33;ATR=date"`
	AlternatePlacerOrderNumber []CX `hl7:"POS=34"`
	OrderWorkflowProfile []EI `hl7:"POS=35"`
}
