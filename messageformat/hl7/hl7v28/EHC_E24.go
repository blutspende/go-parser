...
type EHC_E24_AUTHORIZATION_RESPONSE_INFO struct {
	...
	Psl_item_info []EHC_E24_AUTHORIZATION_RESPONSE_INFO_PSL_ITEM_INFO `hl7:"GROUP"`
}
...
// https://hl7-definition.caristix.com/v2/HL7v2.8/TriggerEvents/EHC_E24
type EHC_E24 struct {
	...
	Authorization_response_info EHC_E24_AUTHORIZATION_RESPONSE_INFO `hl7:"GROUP"`
}
