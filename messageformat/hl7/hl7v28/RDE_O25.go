...
type RDE_O25_ORDER struct {
	...
	Infusion_order []RDE_O25_ORDER_INFUSION_ORDER `hl7:"GROUP;ATR=optional"`
...
// RDE_O25_ORDER_INFUSION_ORDER - Group struct
type RDE_O25_ORDER_INFUSION_ORDER struct {
	PharmacyTreatmentInfusion RXV `hl7:"TAG=RXV"`
	ParticipationInformation []PRT `hl7:"TAG=PRT;ATR=optional"`
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
	Timing_encoded []RDE_O25_ORDER_INFUSION_ORDER_TIMING_ENCODED `hl7:"GROUP"`
}

// RDE_O25_ORDER_INFUSION_ORDER_TIMING_ENCODED - Group struct
type RDE_O25_ORDER_INFUSION_ORDER_TIMING_ENCODED struct {
	TimingQuantity TQ1 `hl7:"TAG=TQ1"`
	TimingQuantityRelationship []TQ2 `hl7:"TAG=TQ2;ATR=optional"`
}
...
// https://hl7-definition.caristix.com/v2/HL7v2.8/TriggerEvents/RDE_O25
type RDE_O25 struct {
