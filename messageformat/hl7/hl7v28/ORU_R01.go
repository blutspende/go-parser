...
type ORU_R01_PATIENT_RESULT_ORDER_OBSERVATION struct {
	Common_order ORU_R01_PATIENT_RESULT_ORDER_OBSERVATION_COMMON_ORDER `hl7:"GROUP;ATR=optional"`
...
// ORU_R01_PATIENT_RESULT_ORDER_OBSERVATION_COMMON_ORDER - Group struct
type ORU_R01_PATIENT_RESULT_ORDER_OBSERVATION_COMMON_ORDER struct {
	CommonOrder ORC `hl7:"TAG=ORC;ATR=optional"`
	ParticipationInformation []PRT `hl7:"TAG=PRT;ATR=optional"`
	Order_document ORU_R01_PATIENT_RESULT_ORDER_OBSERVATION_COMMON_ORDER_ORDER_DOCUMENT `hl7:"GROUP;ATR=optional"`
}

// ORU_R01_PATIENT_RESULT_ORDER_OBSERVATION_COMMON_ORDER_ORDER_DOCUMENT - Group struct
type ORU_R01_PATIENT_RESULT_ORDER_OBSERVATION_COMMON_ORDER_ORDER_DOCUMENT struct {
	ObservationResult OBX `hl7:"TAG=OBX"`
	ParticipationInformation []PRT `hl7:"TAG=PRT;ATR=optional"`
...
// https://hl7-definition.caristix.com/v2/HL7v2.8/TriggerEvents/ORU_R01
type ORU_R01 struct {
