...
type PPG_PCJ_PATHWAY_GOAL_ORDER_ORDER_DETAIL struct {
	Choice PPG_PCJ_PATHWAY_GOAL_ORDER_ORDER_DETAIL_CHOICE `hl7:"GROUP"`
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
	Variance []VAR `hl7:"TAG=VAR;ATR=optional"`
	Order_observation []PPG_PCJ_PATHWAY_GOAL_ORDER_ORDER_DETAIL_ORDER_OBSERVATION `hl7:"GROUP;ATR=optional"`
}

// PPG_PCJ_PATHWAY_GOAL_ORDER_ORDER_DETAIL_CHOICE - Group struct
type PPG_PCJ_PATHWAY_GOAL_ORDER_ORDER_DETAIL_CHOICE struct {
...
// https://hl7-definition.caristix.com/v2/HL7v2.8/TriggerEvents/PPG_PCJ
type PPG_PCJ struct {
