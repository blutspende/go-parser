...
// OPU_R25_PATIENT_VISIT_OBSERVATION - Group struct
...
type OPU_R25_ACCESSION_DETAIL_PATIENT struct {
	...
	Patient_observation []OPU_R25_ACCESSION_DETAIL_PATIENT_PATIENT_OBSERVATION `hl7:"GROUP;ATR=optional"`
}
...
type OPU_R25_ACCESSION_DETAIL_SPECIMEN struct {
	...
	Specimen_observation []OPU_R25_ACCESSION_DETAIL_SPECIMEN_SPECIMEN_OBSERVATION `hl7:"GROUP;ATR=optional"`
...
type OPU_R25_ACCESSION_DETAIL_SPECIMEN_ORDER struct {
	...
	Common_order OPU_R25_ACCESSION_DETAIL_SPECIMEN_ORDER_COMMON_ORDER `hl7:"GROUP;ATR=optional"`
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
	ParticipationInformation2 []PRT `hl7:"TAG=PRT;ATR=optional"`
	Timing_qty []OPU_R25_ACCESSION_DETAIL_SPECIMEN_ORDER_TIMING_QTY `hl7:"GROUP;ATR=optional"`
	Result []OPU_R25_ACCESSION_DETAIL_SPECIMEN_ORDER_RESULT `hl7:"GROUP"`
}

// OPU_R25_ACCESSION_DETAIL_SPECIMEN_ORDER_COMMON_ORDER - Group struct
type OPU_R25_ACCESSION_DETAIL_SPECIMEN_ORDER_COMMON_ORDER struct {
...
// https://hl7-definition.caristix.com/v2/HL7v2.8/TriggerEvents/OPU_R25
type OPU_R25 struct {
	...
	ParticipationInformation []PRT `hl7:"TAG=PRT;ATR=optional"`
	Patient_visit_observation []OPU_R25_PATIENT_VISIT_OBSERVATION `hl7:"GROUP;ATR=optional"`
	Accession_detail []OPU_R25_ACCESSION_DETAIL `hl7:"GROUP"`
}
