...
// https://hl7-definition.caristix.com/v2/HL7v2.8/Segments/OBX
type OBX struct {
	...
	InterpretationCodes []CWE `hl7:"POS=9"`
	...
	PatientResultsReleaseCategory string `hl7:"POS=27"`
	RootCause CWE `hl7:"POS=28"`
	LocalProcessControl []CWE `hl7:"POS=29"`
}
