...
type OUL_R23_SPECIMEN_CONTAINER_ORDER struct {
	...
	Common_order OUL_R23_SPECIMEN_CONTAINER_ORDER_COMMON_ORDER `hl7:"GROUP;ATR=optional"`
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
...
// OUL_R23_SPECIMEN_CONTAINER_ORDER_COMMON_ORDER - Group struct
type OUL_R23_SPECIMEN_CONTAINER_ORDER_COMMON_ORDER struct {
	CommonOrder ORC `hl7:"TAG=ORC;ATR=optional"`
	ParticipationInformation []PRT `hl7:"TAG=PRT;ATR=optional"`
	Order_document OUL_R23_SPECIMEN_CONTAINER_ORDER_COMMON_ORDER_ORDER_DOCUMENT `hl7:"GROUP;ATR=optional"`
}

// OUL_R23_SPECIMEN_CONTAINER_ORDER_COMMON_ORDER_ORDER_DOCUMENT - Group struct
type OUL_R23_SPECIMEN_CONTAINER_ORDER_COMMON_ORDER_ORDER_DOCUMENT struct {
	ObservationResult OBX `hl7:"TAG=OBX"`
	ParticipationInformation []PRT `hl7:"TAG=PRT;ATR=optional"`
...
// https://hl7-definition.caristix.com/v2/HL7v2.8/TriggerEvents/OUL_R23
type OUL_R23 struct {
