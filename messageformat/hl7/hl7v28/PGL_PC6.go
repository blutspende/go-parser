...
type PGL_PC6_GOAL struct {
	...
	Goal_role []PGL_PC6_GOAL_GOAL_ROLE `hl7:"GROUP;ATR=optional"`
...
type PGL_PC6_GOAL_PROBLEM struct {
	...
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
	Variance []VAR `hl7:"TAG=VAR;ATR=optional"`
	Problem_role []PGL_PC6_GOAL_PROBLEM_PROBLEM_ROLE `hl7:"GROUP;ATR=optional"`
	Problem_observation []PGL_PC6_GOAL_PROBLEM_PROBLEM_OBSERVATION `hl7:"GROUP;ATR=optional"`
}
...
type PGL_PC6_GOAL_ORDER struct {
	...
	Order_detail PGL_PC6_GOAL_ORDER_ORDER_DETAIL `hl7:"GROUP;ATR=optional"`
}

// PGL_PC6_GOAL_ORDER_ORDER_DETAIL - Group struct
type PGL_PC6_GOAL_ORDER_ORDER_DETAIL struct {
	Choice PGL_PC6_GOAL_ORDER_ORDER_DETAIL_CHOICE `hl7:"GROUP"`
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
	Variance []VAR `hl7:"TAG=VAR;ATR=optional"`
	Order_observation []PGL_PC6_GOAL_ORDER_ORDER_DETAIL_ORDER_OBSERVATION `hl7:"GROUP;ATR=optional"`
}

// PGL_PC6_GOAL_ORDER_ORDER_DETAIL_CHOICE - Group struct
type PGL_PC6_GOAL_ORDER_ORDER_DETAIL_CHOICE struct {
...
// PGL_PC6 - PC/ goal add
// https://hl7-definition.caristix.com/v2/HL7v2.8/TriggerEvents/PGL_PC6
type PGL_PC6 struct {
	MessageHeader MSH `hl7:"TAG=MSH"`
	SoftwareSegment []SFT `hl7:"TAG=SFT;ATR=optional"`
	UserAuthenticationCredentialSegment UAC `hl7:"TAG=UAC;ATR=optional"`
	PatientIdentification PID `hl7:"TAG=PID"`
	Patient_visit PGL_PC6_PATIENT_VISIT `hl7:"GROUP;ATR=optional"`
