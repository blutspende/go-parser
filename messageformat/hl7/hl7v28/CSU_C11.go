...
type CSU_C11_PATIENT struct {
	...
	Study_phase []CSU_C11_PATIENT_STUDY_PHASE `hl7:"GROUP"`
}
...
type CSU_C11_PATIENT_STUDY_PHASE struct {
	...
	Study_schedule []CSU_C11_PATIENT_STUDY_PHASE_STUDY_SCHEDULE `hl7:"GROUP"`
}
...
type CSU_C11_PATIENT_STUDY_PHASE_STUDY_SCHEDULE struct {
	...
	Study_observation []CSU_C11_PATIENT_STUDY_PHASE_STUDY_SCHEDULE_STUDY_OBSERVATION `hl7:"GROUP"`
	Study_pharm []CSU_C11_PATIENT_STUDY_PHASE_STUDY_SCHEDULE_STUDY_PHARM `hl7:"GROUP"`
}
...
type CSU_C11_PATIENT_STUDY_PHASE_STUDY_SCHEDULE_STUDY_OBSERVATION struct {
	Common_order CSU_C11_PATIENT_STUDY_PHASE_STUDY_SCHEDULE_STUDY_OBSERVATION_COMMON_ORDER `hl7:"GROUP;ATR=optional"`
	ObservationRequest OBR `hl7:"TAG=OBR"`
	ParticipationInformation1 []PRT `hl7:"TAG=PRT;ATR=optional"`
	Timing_qty []CSU_C11_PATIENT_STUDY_PHASE_STUDY_SCHEDULE_STUDY_OBSERVATION_TIMING_QTY `hl7:"GROUP;ATR=optional"`
	ObservationResult OBX `hl7:"TAG=OBX"`
	ParticipationInformation2 []PRT `hl7:"TAG=PRT;ATR=optional"`
}

// CSU_C11_PATIENT_STUDY_PHASE_STUDY_SCHEDULE_STUDY_OBSERVATION_COMMON_ORDER - Group struct
type CSU_C11_PATIENT_STUDY_PHASE_STUDY_SCHEDULE_STUDY_OBSERVATION_COMMON_ORDER struct {
...
type CSU_C11_PATIENT_STUDY_PHASE_STUDY_SCHEDULE_STUDY_PHARM struct {
	Common_order CSU_C11_PATIENT_STUDY_PHASE_STUDY_SCHEDULE_STUDY_PHARM_COMMON_ORDER `hl7:"GROUP;ATR=optional"`
	Rx_admin []CSU_C11_PATIENT_STUDY_PHASE_STUDY_SCHEDULE_STUDY_PHARM_RX_ADMIN `hl7:"GROUP"`
}

// CSU_C11_PATIENT_STUDY_PHASE_STUDY_SCHEDULE_STUDY_PHARM_COMMON_ORDER - Group struct
type CSU_C11_PATIENT_STUDY_PHASE_STUDY_SCHEDULE_STUDY_PHARM_COMMON_ORDER struct {
...
// https://hl7-definition.caristix.com/v2/HL7v2.8/TriggerEvents/CSU_C11
type CSU_C11 struct {
