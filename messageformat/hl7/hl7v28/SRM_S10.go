...
type SRM_S10_PATIENT struct {
	...
	Observation []SRM_S10_PATIENT_OBSERVATION `hl7:"GROUP;ATR=optional"`
	Diagnosis []DG1 `hl7:"TAG=DG1;ATR=optional"`
}

// SRM_S10_PATIENT_OBSERVATION - Group struct
type SRM_S10_PATIENT_OBSERVATION struct {
...
type SRM_S10_RESOURCES struct {
	...
	General_resource []SRM_S10_RESOURCES_GENERAL_RESOURCE `hl7:"GROUP;ATR=optional"`
	Location_resource []SRM_S10_RESOURCES_LOCATION_RESOURCE `hl7:"GROUP;ATR=optional"`
	Personnel_resource []SRM_S10_RESOURCES_PERSONNEL_RESOURCE `hl7:"GROUP;ATR=optional"`
}
...
// https://hl7-definition.caristix.com/v2/HL7v2.8/TriggerEvents/SRM_S10
type SRM_S10 struct {
