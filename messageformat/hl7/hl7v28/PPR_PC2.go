...
type PPR_PC2_PROBLEM_ORDER_ORDER_DETAIL struct {
	Choice PPR_PC2_PROBLEM_ORDER_ORDER_DETAIL_CHOICE `hl7:"GROUP"`
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
	Variance []VAR `hl7:"TAG=VAR;ATR=optional"`
	Order_observation []PPR_PC2_PROBLEM_ORDER_ORDER_DETAIL_ORDER_OBSERVATION `hl7:"GROUP;ATR=optional"`
}

// PPR_PC2_PROBLEM_ORDER_ORDER_DETAIL_CHOICE - Group struct
type PPR_PC2_PROBLEM_ORDER_ORDER_DETAIL_CHOICE struct {
...
// https://hl7-definition.caristix.com/v2/HL7v2.8/TriggerEvents/PPR_PC2
type PPR_PC2 struct {
