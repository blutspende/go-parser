...
// ORU_R30_PATIENT_OBSERVATION - Group struct
...
// https://hl7-definition.caristix.com/v2/HL7v2.8/TriggerEvents/ORU_R30
type ORU_R30 struct {
	...
	Patient_observation []ORU_R30_PATIENT_OBSERVATION `hl7:"GROUP;ATR=optional"`
	...
	Timing_qty []ORU_R30_TIMING_QTY `hl7:"GROUP;ATR=optional"`
