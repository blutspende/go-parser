...
type RSP_E22_QUERY_ACK struct {
	...
	Authorization_info RSP_E22_QUERY_ACK_AUTHORIZATION_INFO `hl7:"GROUP;ATR=optional"`
}
...
type RSP_E22_QUERY_ACK_AUTHORIZATION_INFO struct {
	...
	Psl_item_info []RSP_E22_QUERY_ACK_AUTHORIZATION_INFO_PSL_ITEM_INFO `hl7:"GROUP"`
}
...
// https://hl7-definition.caristix.com/v2/HL7v2.8/TriggerEvents/RSP_E22
type RSP_E22 struct {
	...
	Query_ack RSP_E22_QUERY_ACK `hl7:"GROUP"`
}
