...
// https://hl7-definition.caristix.com/v2/HL7v2.8/Segments/RXD
type RXD struct {
	DispenseSubIDCounter *int `hl7:"POS=2"`
	DispenseGiveCode CWE `hl7:"POS=3"`
	DateTimeDispensed time.Time `hl7:"POS=4"`
	ActualDispenseAmount *int `hl7:"POS=5"`
	ActualDispenseUnits CWE `hl7:"POS=6"`
	ActualDosageForm CWE `hl7:"POS=7"`
	...
	PharmacyTreatmentSuppliersSpecialDispensingInstructions []CWE `hl7:"POS=16"`
	ActualStrength *int `hl7:"POS=17"`
	ActualStrengthUnit CWE `hl7:"POS=18"`
	SubstanceLotNumber []string `hl7:"POS=19"`
	SubstanceExpirationDate []time.Time `hl7:"POS=20"`
	SubstanceManufacturerName []CWE `hl7:"POS=21"`
	Indication []CWE `hl7:"POS=22"`
	DispensePackageSize *int `hl7:"POS=23"`
	DispensePackageSizeUnit CWE `hl7:"POS=24"`
	DispensePackageMethod string `hl7:"POS=25"`
	SupplementaryCode []CWE `hl7:"POS=26"`
	InitiatingLocation CWE `hl7:"POS=27"`
	PackagingAssemblyLocation CWE `hl7:"POS=28"`
	...
	PharmacyPhoneNumber []XTN `hl7:"POS=35"`
	DispenseTagIdentifier []EI `hl7:"POS=36"`
}
