...
// https://hl7-definition.caristix.com/v2/HL7v2.8/Segments/IN3
type IN3 struct {
	...
	Days DTN `hl7:"POS=12"`
	NonConcurCodeDescription CWE `hl7:"POS=13"`
	...
	AppealReason CWE `hl7:"POS=18"`
	CertificationAgency CWE `hl7:"POS=19"`
	...
	SecondOpinionStatus CWE `hl7:"POS=24"`
	SecondOpinionDocumentationReceived []CWE `hl7:"POS=25"`
	SecondOpinionPhysician []XCN `hl7:"POS=26"`
	CertificationType CWE `hl7:"POS=27"`
	CertificationCategory CWE `hl7:"POS=28"`
}
