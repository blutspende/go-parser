...
type PPP_PCD_PATHWAY struct {
	...
	Pathway_role []PPP_PCD_PATHWAY_PATHWAY_ROLE `hl7:"GROUP;ATR=optional"`
...
type PPP_PCD_PATHWAY_PROBLEM struct {
	...
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
	Variance []VAR `hl7:"TAG=VAR;ATR=optional"`
	Problem_role []PPP_PCD_PATHWAY_PROBLEM_PROBLEM_ROLE `hl7:"GROUP;ATR=optional"`
	Problem_observation []PPP_PCD_PATHWAY_PROBLEM_PROBLEM_OBSERVATION `hl7:"GROUP;ATR=optional"`
...
type PPP_PCD_PATHWAY_PROBLEM_GOAL struct {
	...
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
	Variance []VAR `hl7:"TAG=VAR;ATR=optional"`
	Goal_role []PPP_PCD_PATHWAY_PROBLEM_GOAL_GOAL_ROLE `hl7:"GROUP;ATR=optional"`
	Goal_observation []PPP_PCD_PATHWAY_PROBLEM_GOAL_GOAL_OBSERVATION `hl7:"GROUP;ATR=optional"`
}
...
type PPP_PCD_PATHWAY_PROBLEM_ORDER struct {
	...
	Order_detail PPP_PCD_PATHWAY_PROBLEM_ORDER_ORDER_DETAIL `hl7:"GROUP;ATR=optional"`
}

// PPP_PCD_PATHWAY_PROBLEM_ORDER_ORDER_DETAIL - Group struct
type PPP_PCD_PATHWAY_PROBLEM_ORDER_ORDER_DETAIL struct {
	Choice PPP_PCD_PATHWAY_PROBLEM_ORDER_ORDER_DETAIL_CHOICE `hl7:"GROUP"`
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
	Variance []VAR `hl7:"TAG=VAR;ATR=optional"`
	Order_observation []PPP_PCD_PATHWAY_PROBLEM_ORDER_ORDER_DETAIL_ORDER_OBSERVATION `hl7:"GROUP;ATR=optional"`
}

// PPP_PCD_PATHWAY_PROBLEM_ORDER_ORDER_DETAIL_CHOICE - Group struct
type PPP_PCD_PATHWAY_PROBLEM_ORDER_ORDER_DETAIL_CHOICE struct {
...
// https://hl7-definition.caristix.com/v2/HL7v2.8/TriggerEvents/PPP_PCD
type PPP_PCD struct {
	MessageHeader MSH `hl7:"TAG=MSH"`
	SoftwareSegment []SFT `hl7:"TAG=SFT;ATR=optional"`
	UserAuthenticationCredentialSegment UAC `hl7:"TAG=UAC;ATR=optional"`
	PatientIdentification PID `hl7:"TAG=PID"`
	Patient_visit PPP_PCD_PATIENT_VISIT `hl7:"GROUP;ATR=optional"`
