...
// ITM - Material Item
// https://hl7-definition.caristix.com/v2/HL7v2.8/Segments/ITM
type ITM struct {
	...
	HazardousIndicator                           CNE    `hl7:"POS=31"`
	SterileIndicator                             CNE    `hl7:"POS=32"`
	MaterialDataSafetySheetNumber                EI     `hl7:"POS=33"`
	UnitedNationsStandardProductsAndServicesCode CWE    `hl7:"POS=34"`
}
