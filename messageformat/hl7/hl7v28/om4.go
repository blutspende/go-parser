...
// https://hl7-definition.caristix.com/v2/HL7v2.8/Segments/OM4
type OM4 struct {
	...
	ContainerUnits CWE `hl7:"POS=6"`
	Specimen CWE `hl7:"POS=7"`
	...
	SpecimenPreference string `hl7:"POS=17"`
	PreferredSpecimenAttributeSequenceID *int `hl7:"POS=18"`
	TaxonomicClassificationCode []CWE `hl7:"POS=19"`
}
