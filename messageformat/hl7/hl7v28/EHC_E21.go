...
type EHC_E21_AUTHORIZATION_REQUEST struct {
	...
	Psl_item_info []EHC_E21_AUTHORIZATION_REQUEST_PSL_ITEM_INFO `hl7:"GROUP"`
}
...
// https://hl7-definition.caristix.com/v2/HL7v2.8/TriggerEvents/EHC_E21
type EHC_E21 struct {
	MessageHeader MSH `hl7:"TAG=MSH"`
	SoftwareSegment []SFT `hl7:"TAG=SFT;ATR=optional"`
	UserAuthenticationCredentialSegment []UAC `hl7:"TAG=UAC;ATR=optional"`
	Authorization_request EHC_E21_AUTHORIZATION_REQUEST `hl7:"GROUP"`
}
