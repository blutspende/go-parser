...
type PPR_PC3_PROBLEM struct {
	...
	Problem_role []PPR_PC3_PROBLEM_PROBLEM_ROLE `hl7:"GROUP;ATR=optional"`
	Pathway []PPR_PC3_PROBLEM_PATHWAY `hl7:"GROUP;ATR=optional"`
	Problem_observation []PPR_PC3_PROBLEM_PROBLEM_OBSERVATION `hl7:"GROUP;ATR=optional"`
...
type PPR_PC3_PROBLEM_GOAL struct {
	...
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
	Variance []VAR `hl7:"TAG=VAR;ATR=optional"`
	Goal_role []PPR_PC3_PROBLEM_GOAL_GOAL_ROLE `hl7:"GROUP;ATR=optional"`
	Goal_observation []PPR_PC3_PROBLEM_GOAL_GOAL_OBSERVATION `hl7:"GROUP;ATR=optional"`
}
...
type PPR_PC3_PROBLEM_ORDER struct {
	...
	Order_detail PPR_PC3_PROBLEM_ORDER_ORDER_DETAIL `hl7:"GROUP;ATR=optional"`
}

// PPR_PC3_PROBLEM_ORDER_ORDER_DETAIL - Group struct
type PPR_PC3_PROBLEM_ORDER_ORDER_DETAIL struct {
	Choice PPR_PC3_PROBLEM_ORDER_ORDER_DETAIL_CHOICE `hl7:"GROUP"`
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
	Variance []VAR `hl7:"TAG=VAR;ATR=optional"`
	Order_observation []PPR_PC3_PROBLEM_ORDER_ORDER_DETAIL_ORDER_OBSERVATION `hl7:"GROUP;ATR=optional"`
}

// PPR_PC3_PROBLEM_ORDER_ORDER_DETAIL_CHOICE - Group struct
type PPR_PC3_PROBLEM_ORDER_ORDER_DETAIL_CHOICE struct {
...
// https://hl7-definition.caristix.com/v2/HL7v2.8/TriggerEvents/PPR_PC3
type PPR_PC3 struct {
	MessageHeader MSH `hl7:"TAG=MSH"`
	SoftwareSegment []SFT `hl7:"TAG=SFT;ATR=optional"`
	UserAuthenticationCredentialSegment UAC `hl7:"TAG=UAC;ATR=optional"`
	PatientIdentification PID `hl7:"TAG=PID"`
	Patient_visit PPR_PC3_PATIENT_VISIT `hl7:"GROUP;ATR=optional"`
