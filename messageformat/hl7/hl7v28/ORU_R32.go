...
// ORU_R32_PATIENT_OBSERVATION - Group struct
type ORU_R32_PATIENT_OBSERVATION struct {
...
// https://hl7-definition.caristix.com/v2/HL7v2.8/TriggerEvents/ORU_R32
type ORU_R32 struct {
	...
	Patient_observation []ORU_R32_PATIENT_OBSERVATION `hl7:"GROUP;ATR=optional"`
	Visit ORU_R32_VISIT `hl7:"GROUP;ATR=optional"`
	CommonOrder ORC `hl7:"TAG=ORC"`
	ParticipationInformation2 []PRT `hl7:"TAG=PRT;ATR=optional"`
	ObservationRequest OBR `hl7:"TAG=OBR"`
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
	ParticipationInformation3 []PRT `hl7:"TAG=PRT;ATR=optional"`
	Timing_qty []ORU_R32_TIMING_QTY `hl7:"GROUP;ATR=optional"`
