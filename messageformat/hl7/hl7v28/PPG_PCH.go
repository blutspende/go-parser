...
type PPG_PCH_PATHWAY struct {
	...
	Pathway_role []PPG_PCH_PATHWAY_PATHWAY_ROLE `hl7:"GROUP;ATR=optional"`
...
type PPG_PCH_PATHWAY_GOAL struct {
	...
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
	Variance []VAR `hl7:"TAG=VAR;ATR=optional"`
	Goal_role []PPG_PCH_PATHWAY_GOAL_GOAL_ROLE `hl7:"GROUP;ATR=optional"`
	Goal_observation []PPG_PCH_PATHWAY_GOAL_GOAL_OBSERVATION `hl7:"GROUP;ATR=optional"`
...
type PPG_PCH_PATHWAY_GOAL_PROBLEM struct {
	...
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
	Variance []VAR `hl7:"TAG=VAR;ATR=optional"`
	Problem_role []PPG_PCH_PATHWAY_GOAL_PROBLEM_PROBLEM_ROLE `hl7:"GROUP;ATR=optional"`
	Problem_observation []PPG_PCH_PATHWAY_GOAL_PROBLEM_PROBLEM_OBSERVATION `hl7:"GROUP;ATR=optional"`
}
...
type PPG_PCH_PATHWAY_GOAL_ORDER struct {
	...
	Order_detail PPG_PCH_PATHWAY_GOAL_ORDER_ORDER_DETAIL `hl7:"GROUP;ATR=optional"`
}

// PPG_PCH_PATHWAY_GOAL_ORDER_ORDER_DETAIL - Group struct
type PPG_PCH_PATHWAY_GOAL_ORDER_ORDER_DETAIL struct {
	Choice PPG_PCH_PATHWAY_GOAL_ORDER_ORDER_DETAIL_CHOICE `hl7:"GROUP"`
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
	Variance []VAR `hl7:"TAG=VAR;ATR=optional"`
	Order_observation []PPG_PCH_PATHWAY_GOAL_ORDER_ORDER_DETAIL_ORDER_OBSERVATION `hl7:"GROUP;ATR=optional"`
}

// PPG_PCH_PATHWAY_GOAL_ORDER_ORDER_DETAIL_CHOICE - Group struct
type PPG_PCH_PATHWAY_GOAL_ORDER_ORDER_DETAIL_CHOICE struct {
...
// https://hl7-definition.caristix.com/v2/HL7v2.8/TriggerEvents/PPG_PCH
type PPG_PCH struct {
	MessageHeader MSH `hl7:"TAG=MSH"`
	SoftwareSegment []SFT `hl7:"TAG=SFT;ATR=optional"`
	UserAuthenticationCredentialSegment UAC `hl7:"TAG=UAC;ATR=optional"`
	PatientIdentification PID `hl7:"TAG=PID"`
	Patient_visit PPG_PCH_PATIENT_VISIT `hl7:"GROUP;ATR=optional"`
