...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/PI
type PI struct {
...
// MO - Money
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/MO
type MO struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/LA1
type LA1 struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/CQ
type CQ struct {
	Quantity *int `hl7:"POS=1"`
...
// NA - Numeric Array
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/NA
type NA struct {
...
// FC - Financial Class
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/FC
type FC struct {
...
// SAD - Street Address
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/SAD
type SAD struct {
...
// OSD - Order Sequence
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/OSD
type OSD struct {
...
// DIN - Activation Date
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/DIN
type DIN struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/CF
type CF struct {
...
// EIP - Parent Order
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/EIP
type EIP struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/SCV
type SCV struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/CD
type CD struct {
...
// CE - Coded Element
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/CE
type CE struct {
	Identifier string `hl7:"POS=1"`
...
// PIP - Privileges
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/PIP
type PIP struct {
...
// RI - Repeat Interval
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/RI
type RI struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/LA2
type LA2 struct {
	PointOfCare string `hl7:"POS=1"`
	Room string `hl7:"POS=2"`
	Bed string `hl7:"POS=3"`
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/XCN
type XCN struct {
	IDNumber string `hl7:"POS=1"`
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/QSC
type QSC struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/ED
type ED struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/DLD
type DLD struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/PLN
type PLN struct {
	IDNumber string `hl7:"POS=1"`
	TypeOfIDNumber string `hl7:"POS=2"`
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/CNN
type CNN struct {
	IDNumber string `hl7:"POS=1"`
...
// OCD - Occurrence
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/OCD
type OCD struct {
...
// PN - Person Name
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/PN
type PN struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/DLN
type DLN struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/CSU
type CSU struct {
...
// JCC - Job Code/class
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/JCC
type JCC struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/DTN
type DTN struct {
...
// WVS - Waveform Source
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/WVS
type WVS struct {
...
// MSG - Message Type
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/MSG
type MSG struct {
...
// DR - Date/time Range
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/DR
type DR struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/CNE
type CNE struct {
	Identifier string `hl7:"POS=1"`
	Text string `hl7:"POS=2"`
	NameOfCodingSystem string `hl7:"POS=3"`
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/CN
type CN struct {
	IDNumber string `hl7:"POS=1"`
	FamilyName FN `hl7:"POS=2"`
	GivenName string `hl7:"POS=3"`
...
// CP - Composite Price
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/CP
type CP struct {
	Price MO `hl7:"POS=1"`
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/XTN
type XTN struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/MOP
type MOP struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/CX
type CX struct {
	ID string `hl7:"POS=1"`
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/CCP
type CCP struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/NDL
type NDL struct {
	OpName CNN `hl7:"POS=1"`
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/RCD
type RCD struct {
	SegmentFieldName string `hl7:"POS=1"`
...
// AD - Address
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/AD
type AD struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/AUI
type AUI struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/MOC
type MOC struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/CK
type CK struct {
...
// PT - Processing Type
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/PT
type PT struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/DDI
type DDI struct {
...
// TQ - Timing Quantity
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/TQ
type TQ struct {
	...
	ConjunctionComponent string `hl7:"POS=9"`
...
// VR - Value Qualifier
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/VR
type VR struct {
...
// FN - Family Name
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/FN
type FN struct {
...
// RMC - Room Coverage
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/RMC
type RMC struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/PPN
type PPN struct {
	IDNumber string `hl7:"POS=1"`
	FamilyName FN `hl7:"POS=2"`
	GivenName string `hl7:"POS=3"`
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/XON
type XON struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/QIP
type QIP struct {
	SegmentFieldName string `hl7:"POS=1"`
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/PRL
type PRL struct {
...
// DLT - Delta Check
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/DLT
type DLT struct {
	Range NR `hl7:"POS=1"`
...
// PTA - Policy Type
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/PTA
type PTA struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/XPN
type XPN struct {
	FamilyName FN `hl7:"POS=1"`
	GivenName string `hl7:"POS=2"`
	SecondAndFurtherGivenNamesOrInitialsThereof string `hl7:"POS=3"`
...
// SPD - Specialty
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/SPD
type SPD struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/UVC
type UVC struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/CWE
type CWE struct {
	Identifier string `hl7:"POS=1"`
	Text string `hl7:"POS=2"`
	NameOfCodingSystem string `hl7:"POS=3"`
...
// SRT - Sort Order
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/SRT
type SRT struct {
...
// TS - Time Stamp
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/TS
type TS struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/RP
type RP struct {
...
// RFR - Reference Range
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/RFR
type RFR struct {
	NumericRange NR `hl7:"POS=1"`
	AdministrativeSex string `hl7:"POS=2"`
	AgeRange NR `hl7:"POS=3"`
	GestationalRange NR `hl7:"POS=4"`
...
// ELD - Error
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/ELD
type ELD struct {
...
// OSP - Occurrence Span
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/OSP
type OSP struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/VID
type VID struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/HD
type HD struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/PCF
type PCF struct {
...
// SPS - Specimen Source
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/SPS
type SPS struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/EI
type EI struct {
...
// PL - Person Location
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/PL
type PL struct {
	PointOfCare string `hl7:"POS=1"`
	Room string `hl7:"POS=2"`
	Bed string `hl7:"POS=3"`
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/MA
type MA struct {
	Sample1FromChannel1 *int `hl7:"POS=1"`
	Sample1FromChannel2 *int `hl7:"POS=2"`
	Sample1FromChannel3 *int `hl7:"POS=3"`
	Sample1FromChannel4 *int `hl7:"POS=4"`
	Sample1FromChannel5 *int `hl7:"POS=5"`
	Sample1FromChannel6 *int `hl7:"POS=6"`
}

// SN - Structured Numeric
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/SN
type SN struct {
...
// CCD - Charge Time
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/CCD
type CCD struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/WVI
type WVI struct {
...
// NR - Wertebereich
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/NR
type NR struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/XAD
type XAD struct {
...
// VH - Visiting Hours
// https://hl7-definition-staging.caristix.com/v2/HL7v2.4/DataTypes/VH
type VH struct {
