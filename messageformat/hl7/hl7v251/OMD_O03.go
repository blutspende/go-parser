...
type OMD_O03_ORDER_DIET struct {
	...
	TimingDiet []OMD_O03_ORDER_DIET_TIMING_DIET `hl7:"GROUP;ATR=optional"`
...
type OMD_O03_ORDER_TRAY struct {
	CommonOrder ORC `hl7:"TAG=ORC"`
	TimingTray []OMD_O03_ORDER_TRAY_TIMING_TRAY `hl7:"GROUP;ATR=optional"`
...
// https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/OMD_O03
type OMD_O03 struct {
