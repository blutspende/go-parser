...
type SRM_S05_RESOURCES struct {
	...
	GeneralResource []SRM_S05_RESOURCES_GENERAL_RESOURCE `hl7:"GROUP;ATR=optional"`
	LocationResource []SRM_S05_RESOURCES_LOCATION_RESOURCE `hl7:"GROUP;ATR=optional"`
	PersonnelResource []SRM_S05_RESOURCES_PERSONNEL_RESOURCE `hl7:"GROUP;ATR=optional"`
}
...
// https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/SRM_S05
type SRM_S05 struct {
