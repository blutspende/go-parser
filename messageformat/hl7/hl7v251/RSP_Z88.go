...
type RSP_Z88_QUERY_RESPONSE struct {
	...
	CommonOrder []RSP_Z88_QUERY_RESPONSE_COMMON_ORDER `hl7:"GROUP"`
}
...
type RSP_Z88_QUERY_RESPONSE_COMMON_ORDER struct {
	...
	OrderDetail RSP_Z88_QUERY_RESPONSE_COMMON_ORDER_ORDER_DETAIL `hl7:"GROUP;ATR=optional"`
	OrderEncoded RSP_Z88_QUERY_RESPONSE_COMMON_ORDER_ORDER_ENCODED `hl7:"GROUP;ATR=optional"`
...
type RSP_Z88_QUERY_RESPONSE_COMMON_ORDER_ORDER_ENCODED struct {
	...
	TimingEncoded []RSP_Z88_QUERY_RESPONSE_COMMON_ORDER_ORDER_ENCODED_TIMING_ENCODED `hl7:"GROUP;ATR=optional"`
	PharmacyTreatmentRoute []RXR `hl7:"TAG=RXR"`
	PharmacyTreatmentComponentOrder []RXC `hl7:"TAG=RXC;ATR=optional"`
}
...
// https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RSP_Z88
type RSP_Z88 struct {
	...
	QueryResponse []RSP_Z88_QUERY_RESPONSE `hl7:"GROUP"`
