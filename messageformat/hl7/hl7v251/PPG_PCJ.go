...
type PPG_PCJ_PATHWAY struct {
	...
	PathwayRole []PPG_PCJ_PATHWAY_PATHWAY_ROLE `hl7:"GROUP;ATR=optional"`
...
type PPG_PCJ_PATHWAY_GOAL struct {
	...
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
	Variance []VAR `hl7:"TAG=VAR;ATR=optional"`
	GoalRole []PPG_PCJ_PATHWAY_GOAL_GOAL_ROLE `hl7:"GROUP;ATR=optional"`
	GoalObservation []PPG_PCJ_PATHWAY_GOAL_GOAL_OBSERVATION `hl7:"GROUP;ATR=optional"`
...
type PPG_PCJ_PATHWAY_GOAL_PROBLEM struct {
	...
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
	Variance []VAR `hl7:"TAG=VAR;ATR=optional"`
	ProblemRole []PPG_PCJ_PATHWAY_GOAL_PROBLEM_PROBLEM_ROLE `hl7:"GROUP;ATR=optional"`
	ProblemObservation []PPG_PCJ_PATHWAY_GOAL_PROBLEM_PROBLEM_OBSERVATION `hl7:"GROUP;ATR=optional"`
}
...
type PPG_PCJ_PATHWAY_GOAL_ORDER struct {
	...
	OrderDetail PPG_PCJ_PATHWAY_GOAL_ORDER_ORDER_DETAIL `hl7:"GROUP;ATR=optional"`
}

// PPG_PCJ_PATHWAY_GOAL_ORDER_ORDER_DETAIL - Group struct
type PPG_PCJ_PATHWAY_GOAL_ORDER_ORDER_DETAIL struct {
	OrderDetailSegment PPG_PCJ_PATHWAY_GOAL_ORDER_ORDER_DETAIL_ORDER_DETAIL_SEGMENT `hl7:"GROUP"`
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
	Variance []VAR `hl7:"TAG=VAR;ATR=optional"`
	OrderObservation []PPG_PCJ_PATHWAY_GOAL_ORDER_ORDER_DETAIL_ORDER_OBSERVATION `hl7:"GROUP;ATR=optional"`
}

// PPG_PCJ_PATHWAY_GOAL_ORDER_ORDER_DETAIL_ORDER_DETAIL_SEGMENT - Group struct
type PPG_PCJ_PATHWAY_GOAL_ORDER_ORDER_DETAIL_ORDER_DETAIL_SEGMENT struct {
...
// https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/PPG_PCJ
type PPG_PCJ struct {
	MessageHeader MSH `hl7:"TAG=MSH"`
	SoftwareSegment []SFT `hl7:"TAG=SFT;ATR=optional"`
	PatientIdentification PID `hl7:"TAG=PID"`
	PatientVisit PPG_PCJ_PATIENT_VISIT `hl7:"GROUP;ATR=optional"`
