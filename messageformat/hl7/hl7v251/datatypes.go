...
// MO - Money
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/MO
type MO struct {
...
// ERL - Error Location
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/ERL
type ERL struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/LA1
type LA1 struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/CQ
type CQ struct {
	Quantity *int `hl7:"POS=1"`
	Units CE `hl7:"POS=2"`
}
...
// NA - Numeric Array
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/NA
type NA struct {
	Value1 *int `hl7:"POS=1"`
	Value2 *int `hl7:"POS=2"`
	Value3 *int `hl7:"POS=3"`
	Value4 *int `hl7:"POS=4"`
	Value5 *int `hl7:"POS=5"`
	Value6 *int `hl7:"POS=6"`
	Value7 *int `hl7:"POS=7"`
	Value8 *int `hl7:"POS=8"`
	Value9 *int `hl7:"POS=9"`
	Value10 *int `hl7:"POS=10"`
}

// FC - Financial Class
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/FC
type FC struct {
...
// SAD - Street Address
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/SAD
type SAD struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/OSD
type OSD struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/DIN
type DIN struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/CF
type CF struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/EIP
type EIP struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/SCV
type SCV struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/CD
type CD struct {
...
// CE - Coded Element
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/CE
type CE struct {
	Identifier string `hl7:"POS=1"`
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/PIP
type PIP struct {
...
// RI - Repeat Interval
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/RI
type RI struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/LA2
type LA2 struct {
	PointOfCare string `hl7:"POS=1"`
	Room string `hl7:"POS=2"`
	Bed string `hl7:"POS=3"`
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/XCN
type XCN struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/QSC
type QSC struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/ED
type ED struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/DLD
type DLD struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/PLN
type PLN struct {
	IDNumber string `hl7:"POS=1"`
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/CNN
type CNN struct {
	IDNumber string `hl7:"POS=1"`
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/OCD
type OCD struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/DLN
type DLN struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/CSU
type CSU struct {
...
// JCC - Job Code/Class
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/JCC
type JCC struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/DTN
type DTN struct {
...
// WVS - Waveform Source
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/WVS
type WVS struct {
...
// MSG - Message Type
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/MSG
type MSG struct {
...
// DR - Date/Time Range
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/DR
type DR struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/CNE
type CNE struct {
	Identifier string `hl7:"POS=1"`
	Text string `hl7:"POS=2"`
	NameOfCodingSystem string `hl7:"POS=3"`
...
// CP - Composite Price
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/CP
type CP struct {
	Price MO `hl7:"POS=1"`
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/XTN
type XTN struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/MOP
type MOP struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/CX
type CX struct {
	IDNumber string `hl7:"POS=1"`
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/ICD
type ICD struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/CCP
type CCP struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/NDL
type NDL struct {
	Name CNN `hl7:"POS=1"`
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/RCD
type RCD struct {
	SegmentFieldName string `hl7:"POS=1"`
...
// AD - Address
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/AD
type AD struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/AUI
type AUI struct {
...
// MOC - Money and Code
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/MOC
type MOC struct {
...
// PT - Processing Type
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/PT
type PT struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/DDI
type DDI struct {
...
// TQ - Timing Quantity
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/TQ
type TQ struct {
...
// VR - Value Range
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/VR
type VR struct {
...
// FN - Family Name
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/FN
type FN struct {
...
// RMC - Room Coverage
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/RMC
type RMC struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/PPN
type PPN struct {
	IDNumber string `hl7:"POS=1"`
	FamilyName FN `hl7:"POS=2"`
	GivenName string `hl7:"POS=3"`
...
// RPT - Repeat Pattern
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/RPT
type RPT struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/QIP
type QIP struct {
	SegmentFieldName string `hl7:"POS=1"`
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/PRL
type PRL struct {
	ParentObservationIdentifier CE `hl7:"POS=1"`
	ParentObservationSubIdentifier string `hl7:"POS=2"`
	ParentObservationValueDescriptor string `hl7:"POS=3"`
}

// DLT - Delta
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/DLT
type DLT struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/PTA
type PTA struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/XPN
type XPN struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/SPD
type SPD struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/UVC
type UVC struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/CWE
type CWE struct {
	Identifier string `hl7:"POS=1"`
	Text string `hl7:"POS=2"`
	NameOfCodingSystem string `hl7:"POS=3"`
...
// SRT - Sort Order
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/SRT
type SRT struct {
...
// TS - Time Stamp
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/TS
type TS struct {
	Time time.Time `hl7:"POS=1"`
	DegreeOfPrecision string `hl7:"POS=2"`
}

// RP - Reference Pointer
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/RP
type RP struct {
...
// RFR - Reference Range
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/RFR
type RFR struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/ELD
type ELD struct {
	SegmentID string `hl7:"POS=1"`
	SegmentSequence *int `hl7:"POS=2"`
	FieldPosition *int `hl7:"POS=3"`
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/OSP
type OSP struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/VID
type VID struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/HD
type HD struct {
...
// SPS - Specimen Source
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/SPS
type SPS struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/EI
type EI struct {
...
// PL - Person Location
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/PL
type PL struct {
	PointOfCare string `hl7:"POS=1"`
	Room string `hl7:"POS=2"`
	Bed string `hl7:"POS=3"`
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/MA
type MA struct {
	Sample1FromChannel1 *int `hl7:"POS=1"`
	Sample1FromChannel2 *int `hl7:"POS=2"`
	Sample1FromChannelN *int `hl7:"POS=3"`
	Sample2FromChannel1 *int `hl7:"POS=4"`
	Sample2FromChannelN *int `hl7:"POS=5"`
	SampleNFromChannelN *int `hl7:"POS=6"`
}

// SN - Structured Numeric
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/SN
type SN struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/CCD
type CCD struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/WVI
type WVI struct {
...
// NR - Numeric Range
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/NR
type NR struct {
...
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/XAD
type XAD struct {
...
// VH - Visiting Hours
// https://hl7-definition-staging.caristix.com/v2/HL7v2.5.1/DataTypes/VH
type VH struct {
