...
type OUL_R24_ORDER struct {
	...
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
	TimingQty []OUL_R24_ORDER_TIMING_QTY `hl7:"GROUP;ATR=optional"`
...
// https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/OUL_R24
type OUL_R24 struct {
	MessageHeader MSH `hl7:"TAG=MSH"`
	SoftwareSegment []SFT `hl7:"TAG=SFT;ATR=optional"`
	NotesAndComments NTE `hl7:"TAG=NTE;ATR=optional"`
	Patient OUL_R24_PATIENT `hl7:"GROUP;ATR=optional"`
	Visit OUL_R24_VISIT `hl7:"GROUP;ATR=optional"`
