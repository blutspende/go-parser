...
type OMG_O19_PATIENT struct {
	...
	PatientVisit OMG_O19_PATIENT_PATIENT_VISIT `hl7:"GROUP;ATR=optional"`
...
type OMG_O19_ORDER struct {
	...
	PriorResult []OMG_O19_ORDER_PRIOR_RESULT `hl7:"GROUP;ATR=optional"`
...
type OMG_O19_ORDER_PRIOR_RESULT struct {
	PatientPrior OMG_O19_ORDER_PRIOR_RESULT_PATIENT_PRIOR `hl7:"GROUP;ATR=optional"`
	PatientVisitPrior OMG_O19_ORDER_PRIOR_RESULT_PATIENT_VISIT_PRIOR `hl7:"GROUP;ATR=optional"`
	PatientAllergyInformation []AL1 `hl7:"TAG=AL1;ATR=optional"`
	OrderPrior []OMG_O19_ORDER_PRIOR_RESULT_ORDER_PRIOR `hl7:"GROUP"`
}
...
type OMG_O19_ORDER_PRIOR_RESULT_ORDER_PRIOR struct {
	...
	ObservationRequest OBR `hl7:"TAG=OBR"`
	TimingPrior []OMG_O19_ORDER_PRIOR_RESULT_ORDER_PRIOR_TIMING_PRIOR `hl7:"GROUP;ATR=optional"`
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
	ContactData CTD `hl7:"TAG=CTD;ATR=optional"`
	ObservationPrior []OMG_O19_ORDER_PRIOR_RESULT_ORDER_PRIOR_OBSERVATION_PRIOR `hl7:"GROUP"`
}
...
// https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/OMG_O19
type OMG_O19 struct {
