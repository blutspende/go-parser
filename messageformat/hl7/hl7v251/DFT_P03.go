...
type DFT_P03_COMMON_ORDER struct {
	...
	TimingQuantity []DFT_P03_COMMON_ORDER_TIMING_QUANTITY `hl7:"GROUP;ATR=optional"`
...
type DFT_P03_FINANCIAL_FINANCIAL_COMMON_ORDER struct {
	CommonOrder ORC `hl7:"TAG=ORC;ATR=optional"`
	FinancialTimingQuantity []DFT_P03_FINANCIAL_FINANCIAL_COMMON_ORDER_FINANCIAL_TIMING_QUANTITY `hl7:"GROUP;ATR=optional"`
...
// https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/DFT_P03
type DFT_P03 struct {
