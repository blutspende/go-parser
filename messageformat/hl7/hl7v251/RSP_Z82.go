...
type RSP_Z82_QUERY_RESPONSE struct {
	...
	CommonOrder []RSP_Z82_QUERY_RESPONSE_COMMON_ORDER `hl7:"GROUP"`
}
...
type RSP_Z82_QUERY_RESPONSE_COMMON_ORDER struct {
	...
	Timing RSP_Z82_QUERY_RESPONSE_COMMON_ORDER_TIMING `hl7:"GROUP"`
	OrderDetail RSP_Z82_QUERY_RESPONSE_COMMON_ORDER_ORDER_DETAIL `hl7:"GROUP;ATR=optional"`
	EncodedOrder RSP_Z82_QUERY_RESPONSE_COMMON_ORDER_ENCODED_ORDER `hl7:"GROUP;ATR=optional"`
...
type RSP_Z82_QUERY_RESPONSE_COMMON_ORDER_ENCODED_ORDER struct {
	...
	TimingEncoded RSP_Z82_QUERY_RESPONSE_COMMON_ORDER_ENCODED_ORDER_TIMING_ENCODED `hl7:"GROUP"`
	PharmacyTreatmentRoute []RXR `hl7:"TAG=RXR"`
	PharmacyTreatmentComponentOrder []RXC `hl7:"TAG=RXC;ATR=optional"`
}
...
// https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/RSP_Z82
type RSP_Z82 struct {
	...
	QueryResponse []RSP_Z82_QUERY_RESPONSE `hl7:"GROUP"`
