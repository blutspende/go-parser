...
// https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/MDM_T02
type MDM_T02 struct {
	...
	CommonOrder []MDM_T02_COMMON_ORDER `hl7:"GROUP;ATR=optional"`
	TranscriptionDocumentHeader TXA `hl7:"TAG=TXA"`
	Obxnte []MDM_T02_OBXNTE `hl7:"GROUP"`
}
