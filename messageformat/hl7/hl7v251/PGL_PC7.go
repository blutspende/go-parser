...
type PGL_PC7_GOAL struct {
	...
	GoalRole []PGL_PC7_GOAL_GOAL_ROLE `hl7:"GROUP;ATR=optional"`
...
type PGL_PC7_GOAL_PROBLEM struct {
	...
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
	Variance []VAR `hl7:"TAG=VAR;ATR=optional"`
	ProblemRole []PGL_PC7_GOAL_PROBLEM_PROBLEM_ROLE `hl7:"GROUP;ATR=optional"`
	ProblemObservation []PGL_PC7_GOAL_PROBLEM_PROBLEM_OBSERVATION `hl7:"GROUP;ATR=optional"`
}
...
type PGL_PC7_GOAL_ORDER struct {
	...
	OrderDetail PGL_PC7_GOAL_ORDER_ORDER_DETAIL `hl7:"GROUP;ATR=optional"`
}

// PGL_PC7_GOAL_ORDER_ORDER_DETAIL - Group struct
type PGL_PC7_GOAL_ORDER_ORDER_DETAIL struct {
	OrderDetailSegment PGL_PC7_GOAL_ORDER_ORDER_DETAIL_ORDER_DETAIL_SEGMENT `hl7:"GROUP"`
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
	Variance []VAR `hl7:"TAG=VAR;ATR=optional"`
	OrderObservation []PGL_PC7_GOAL_ORDER_ORDER_DETAIL_ORDER_OBSERVATION `hl7:"GROUP;ATR=optional"`
}

// PGL_PC7_GOAL_ORDER_ORDER_DETAIL_ORDER_DETAIL_SEGMENT - Group struct
type PGL_PC7_GOAL_ORDER_ORDER_DETAIL_ORDER_DETAIL_SEGMENT struct {
...
// PGL_PC7 - Goal update
// https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/PGL_PC7
type PGL_PC7 struct {
	MessageHeader MSH `hl7:"TAG=MSH"`
	SoftwareSegment []SFT `hl7:"TAG=SFT;ATR=optional"`
	PatientIdentification PID `hl7:"TAG=PID"`
	PatientVisit PGL_PC7_PATIENT_VISIT `hl7:"GROUP;ATR=optional"`
