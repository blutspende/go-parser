...
type OML_O35_PATIENT struct {
	...
	PatientVisit OML_O35_PATIENT_PATIENT_VISIT `hl7:"GROUP;ATR=optional"`
...
type OML_O35_SPECIMEN struct {
	...
	SpecimenContainer []OML_O35_SPECIMEN_SPECIMEN_CONTAINER `hl7:"GROUP"`
}
...
type OML_O35_SPECIMEN_SPECIMEN_CONTAINER_ORDER struct {
	...
	ObservationRequest OML_O35_SPECIMEN_SPECIMEN_CONTAINER_ORDER_OBSERVATION_REQUEST `hl7:"GROUP;ATR=optional"`
...
type OML_O35_SPECIMEN_SPECIMEN_CONTAINER_ORDER_OBSERVATION_REQUEST struct {
	...
	PriorResult []OML_O35_SPECIMEN_SPECIMEN_CONTAINER_ORDER_OBSERVATION_REQUEST_PRIOR_RESULT `hl7:"GROUP;ATR=optional"`
}
...
type OML_O35_SPECIMEN_SPECIMEN_CONTAINER_ORDER_OBSERVATION_REQUEST_PRIOR_RESULT struct {
	PatientPrior OML_O35_SPECIMEN_SPECIMEN_CONTAINER_ORDER_OBSERVATION_REQUEST_PRIOR_RESULT_PATIENT_PRIOR `hl7:"GROUP;ATR=optional"`
	PatientVisitPrior OML_O35_SPECIMEN_SPECIMEN_CONTAINER_ORDER_OBSERVATION_REQUEST_PRIOR_RESULT_PATIENT_VISIT_PRIOR `hl7:"GROUP;ATR=optional"`
	PatientAllergyInformation []AL1 `hl7:"TAG=AL1;ATR=optional"`
	OrderPrior []OML_O35_SPECIMEN_SPECIMEN_CONTAINER_ORDER_OBSERVATION_REQUEST_PRIOR_RESULT_ORDER_PRIOR `hl7:"GROUP"`
}
...
type OML_O35_SPECIMEN_SPECIMEN_CONTAINER_ORDER_OBSERVATION_REQUEST_PRIOR_RESULT_ORDER_PRIOR struct {
	...
	ObservationRequest OBR `hl7:"TAG=OBR"`
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
	TimingPrior []OML_O35_SPECIMEN_SPECIMEN_CONTAINER_ORDER_OBSERVATION_REQUEST_PRIOR_RESULT_ORDER_PRIOR_TIMING_PRIOR `hl7:"GROUP;ATR=optional"`
	ObservationPrior []OML_O35_SPECIMEN_SPECIMEN_CONTAINER_ORDER_OBSERVATION_REQUEST_PRIOR_RESULT_ORDER_PRIOR_OBSERVATION_PRIOR `hl7:"GROUP"`
}
...
// https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/OML_O35
type OML_O35 struct {
