...
// https://hl7-definition.caristix.com/v2/HL7v2.5.1/TriggerEvents/ADT_A16
type ADT_A16 struct {
	...
	Procedure []ADT_A16_PROCEDURE `hl7:"GROUP;ATR=optional"`
	Guarantor []GT1 `hl7:"TAG=GT1;ATR=optional"`
	Insurance []ADT_A16_INSURANCE `hl7:"GROUP;ATR=optional"`
