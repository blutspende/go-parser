...
// UB2 - Ub92 Data
// https://hl7-definition.caristix.com/v2/HL7v2.2/Segments/UB2
type UB2 struct {
	...
	ValueAmountAndCode3941    []CM_UVC `hl7:"POS=7"`
	OccurrenceCodeAndDate3235 []CM_OCD `hl7:"POS=8"`
	OccurrenceSpanCodeDates36 []CM_OSP `hl7:"POS=9"`
	Ub92Locator2State         []string `hl7:"POS=10"`
	Ub92Locator11State        []string `hl7:"POS=11"`
	Ub92Locator31National     string   `hl7:"POS=12"`
	DocumentControlNumber37   []string `hl7:"POS=13"`
