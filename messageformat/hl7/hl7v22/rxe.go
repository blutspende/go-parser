...
// https://hl7-definition.caristix.com/v2/HL7v2.2/Segments/RXE
type RXE struct {
	...
	OrderingProvidersDeaNumber CN_PERSON `hl7:"POS=14"`
	PharmacistVerifierID CN_PERSON `hl7:"POS=15"`
	...
	PharmacySpecialDispensingInstructions []CE `hl7:"POS=22"`
	GivePerTimeUnit string `hl7:"POS=23"`
	GiveRateAmount CE `hl7:"POS=24"`
