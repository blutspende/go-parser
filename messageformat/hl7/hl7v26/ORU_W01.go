...
type ORU_W01_PATIENT_RESULT_ORDER_OBSERVATION struct {
	...
	TimingQty []ORU_W01_PATIENT_RESULT_ORDER_OBSERVATION_TIMING_QTY `hl7:"GROUP;ATR=optional"`
	ContactData CTD `hl7:"TAG=CTD;ATR=optional"`
	Observation []ORU_W01_PATIENT_RESULT_ORDER_OBSERVATION_OBSERVATION `hl7:"GROUP;ATR=optional"`
	FinancialTransaction []FT1 `hl7:"TAG=FT1;ATR=optional"`
	ClinicalTrialIdentification []CTI `hl7:"TAG=CTI;ATR=optional"`
	Specimen []ORU_W01_PATIENT_RESULT_ORDER_OBSERVATION_SPECIMEN `hl7:"GROUP;ATR=optional"`
}

// ORU_W01_PATIENT_RESULT_ORDER_OBSERVATION_TIMING_QTY - Group struct
type ORU_W01_PATIENT_RESULT_ORDER_OBSERVATION_TIMING_QTY struct {
...
// ORU_W01_PATIENT_RESULT_ORDER_OBSERVATION_SPECIMEN - Group struct
type ORU_W01_PATIENT_RESULT_ORDER_OBSERVATION_SPECIMEN struct {
	Specimen SPM `hl7:"TAG=SPM"`
	ObservationResult []OBX `hl7:"TAG=OBX;ATR=optional"`
}

// ORU_W01 - Waveform Result, Unsolicited Transmission Of Requested Information 
// https://hl7-definition.caristix.com/v2/HL7v2.6/TriggerEvents/ORU_W01
type ORU_W01 struct {
