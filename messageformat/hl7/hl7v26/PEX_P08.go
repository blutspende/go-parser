...
type PEX_P08_EXPERIENCE_PEX_OBSERVATION_PEX_CAUSE_RX_ORDER struct {
	...
	TimingQty []PEX_P08_EXPERIENCE_PEX_OBSERVATION_PEX_CAUSE_RX_ORDER_TIMING_QTY `hl7:"GROUP"`
...
type PEX_P08_EXPERIENCE_PEX_OBSERVATION_PEX_CAUSE_ASSOCIATED_PERSON_ASSOCIATED_RX_ORDER struct {
	PharmacyTreatmentEncodedOrder RXE `hl7:"TAG=RXE"`
	Nk1TimingQty []PEX_P08_EXPERIENCE_PEX_OBSERVATION_PEX_CAUSE_ASSOCIATED_PERSON_ASSOCIATED_RX_ORDER_NK1_TIMING_QTY `hl7:"GROUP"`
	PharmacyTreatmentRoute []RXR `hl7:"TAG=RXR;ATR=optional"`
}
...
// https://hl7-definition.caristix.com/v2/HL7v2.6/TriggerEvents/PEX_P08
type PEX_P08 struct {
