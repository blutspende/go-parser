...
type RDE_O25_PATIENT struct {
	...
	PatientVisit RDE_O25_PATIENT_PATIENT_VISIT `hl7:"GROUP;ATR=optional"`
...
type RDE_O25_ORDER struct {
	...
	OrderDetail RDE_O25_ORDER_ORDER_DETAIL `hl7:"GROUP;ATR=optional"`
	PharmacyTreatmentEncodedOrder RXE `hl7:"TAG=RXE"`
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
	TimingEncoded []RDE_O25_ORDER_TIMING_ENCODED `hl7:"GROUP"`
...
type RDE_O25_ORDER_ORDER_DETAIL struct {
	...
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
	PharmacyTreatmentRoute []RXR `hl7:"TAG=RXR"`
	Components []RDE_O25_ORDER_ORDER_DETAIL_COMPONENTS `hl7:"GROUP;ATR=optional"`
}

// RDE_O25_ORDER_ORDER_DETAIL_COMPONENTS - Group struct
type RDE_O25_ORDER_ORDER_DETAIL_COMPONENTS struct {
...
// https://hl7-definition.caristix.com/v2/HL7v2.6/TriggerEvents/RDE_O25
type RDE_O25 struct {
