...
// https://hl7-definition.caristix.com/v2/HL7v2.6/TriggerEvents/ADT_A31
type ADT_A31 struct {
	...
	Procedure []ADT_A31_PROCEDURE `hl7:"GROUP;ATR=optional"`
	Guarantor []GT1 `hl7:"TAG=GT1;ATR=optional"`
	Insurance []ADT_A31_INSURANCE `hl7:"GROUP;ATR=optional"`
