...
// https://hl7-definition.caristix.com/v2/HL7v2.6/Segments/QRD
type QRD struct {
	...
	WhatSubjectFilter []CWE `hl7:"POS=10"`
	WhatDepartmentDataCode []CWE `hl7:"POS=11"`
	WhatDataCodeValueQualifier []VR `hl7:"POS=12"`
