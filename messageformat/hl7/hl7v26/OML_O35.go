...
type OML_O35_SPECIMEN_SPECIMEN_CONTAINER_ORDER_OBSERVATION_REQUEST_PRIOR_RESULT_ORDER_PRIOR struct {
	...
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
	Role []ROL `hl7:"TAG=ROL;ATR=optional"`
	TimingPrior OML_O35_SPECIMEN_SPECIMEN_CONTAINER_ORDER_OBSERVATION_REQUEST_PRIOR_RESULT_ORDER_PRIOR_TIMING_PRIOR `hl7:"GROUP"`
...
// https://hl7-definition.caristix.com/v2/HL7v2.6/TriggerEvents/OML_O35
type OML_O35 struct {
