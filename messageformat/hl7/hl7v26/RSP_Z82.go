...
type RSP_Z82_QUERY_RESPONSE_COMMON_ORDER_ENCODED_ORDER struct {
	...
	TimingEncoded []RSP_Z82_QUERY_RESPONSE_COMMON_ORDER_ENCODED_ORDER_TIMING_ENCODED `hl7:"GROUP;ATR=optional"`
	PharmacyTreatmentRoute []RXR `hl7:"TAG=RXR"`
	PharmacyTreatmentComponentOrder []RXC `hl7:"TAG=RXC;ATR=optional"`
}
...
// https://hl7-definition.caristix.com/v2/HL7v2.6/TriggerEvents/RSP_Z82
type RSP_Z82 struct {
