...
// https://hl7-definition.caristix.com/v2/HL7v2.6/TriggerEvents/ADT_A01
type ADT_A01 struct {
	...
	Procedure []ADT_A01_PROCEDURE `hl7:"GROUP;ATR=optional"`
	Guarantor []GT1 `hl7:"TAG=GT1;ATR=optional"`
	Insurance []ADT_A01_INSURANCE `hl7:"GROUP;ATR=optional"`
	Accident ACC `hl7:"TAG=ACC;ATR=optional"`
	UniformBilling1 UB1 `hl7:"TAG=UB1;ATR=optional"`
