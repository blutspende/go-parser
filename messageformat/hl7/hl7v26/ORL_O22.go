...
type ORL_O22_RESPONSE_ORDER struct {
	...
	ObservationRequest ORL_O22_RESPONSE_ORDER_OBSERVATION_REQUEST `hl7:"GROUP;ATR=optional"`
}
...
// https://hl7-definition.caristix.com/v2/HL7v2.6/TriggerEvents/ORL_O22
type ORL_O22 struct {
