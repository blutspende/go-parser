...
// https://hl7-definition.caristix.com/v2/HL7v2.5/Segments/PV2
type PV2 struct {
	...
	ModeOfArrivalCode CE `hl7:"POS=39"`
	RecreationalDrugUseCode []CE `hl7:"POS=40"`
	AdmissionLevelOfCareCode CE `hl7:"POS=41"`
	PrecautionCode []CE `hl7:"POS=42"`
	PatientConditionCode CE `hl7:"POS=43"`
	LivingWillCode string `hl7:"POS=44"`
	OrganDonorCode string `hl7:"POS=45"`
	AdvanceDirectiveCode []CE `hl7:"POS=46"`
