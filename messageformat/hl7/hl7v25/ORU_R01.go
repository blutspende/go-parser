...
type ORU_R01_PATIENT_RESULT_ORDER_OBSERVATION struct {
	...
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
	TimingQty []ORU_R01_PATIENT_RESULT_ORDER_OBSERVATION_TIMING_QTY `hl7:"GROUP;ATR=optional"`
...
// https://hl7-definition.caristix.com/v2/HL7v2.5/TriggerEvents/ORU_R01
type ORU_R01 struct {
