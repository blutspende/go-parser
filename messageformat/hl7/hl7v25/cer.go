...
// https://hl7-definition.caristix.com/v2/HL7v2.5/Segments/CER
type CER struct {
	...
	SignatureOfIssuingAuthority ED `hl7:"POS=7"`
	...
	SubjectID string `hl7:"POS=13"`
	SubjectName string `hl7:"POS=14"`
	SubjectDirectoryAttributeExtensionHealthProfessionalData []CWE `hl7:"POS=15"`
	...
	RevocationReasonCode CE `hl7:"POS=31"`
	CertificateStatus CWE `hl7:"POS=32"`
}
