...
// NK1 - Next of kin
// https://hl7-definition.caristix.com/v2/HL7v2.3/Segments/NK1
type NK1 struct {
	...
	NextOfKinJobAssociatedPartiesCodeClass   JCC       `hl7:"POS=12"`
	NextOfKinAssociatedPartiesEmployeeNumber CX        `hl7:"POS=13"`
	OrganizationName                         []XON     `hl7:"POS=14"`
	MaritalStatus                            string    `hl7:"POS=15"`
	Sex                                      string    `hl7:"POS=16"`
	DateOfBirth                              time.Time `hl7:"POS=17"`
	LivingDependency                         []string  `hl7:"POS=18"`
	AmbulatoryStatus                         []string  `hl7:"POS=19"`
	Citizenship                              []string  `hl7:"POS=20"`
	PrimaryLanguage                          CE        `hl7:"POS=21"`
	LivingArrangement                        string    `hl7:"POS=22"`
	PublicityIndicator                       CE        `hl7:"POS=23"`
	ProtectionIndicator                      string    `hl7:"POS=24"`
	StudentIndicator                         string    `hl7:"POS=25"`
	Religion                                 string    `hl7:"POS=26"`
	MothersMaidenName                        XPN       `hl7:"POS=27"`
	NationalityCode                          CE        `hl7:"POS=28"`
	EthnicGroup                              string    `hl7:"POS=29"`
	...
	NextOfKinAssociatedPartyIdentifiers      []CX      `hl7:"POS=34"`
	JobStatus                                string    `hl7:"POS=35"`
	Race                                     string    `hl7:"POS=36"`
