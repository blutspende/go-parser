...
// UB2 - UB92 data
// https://hl7-definition.caristix.com/v2/HL7v2.3/Segments/UB2
type UB2 struct {
	...
	ValueAmountCode []CM_UVC `hl7:"POS=7"`
	OccurrenceCodeDate []CM_OCD `hl7:"POS=8"`
	OccurrenceSpanCodeDates []CM_OSP `hl7:"POS=9"`
