...
// https://hl7-definition.caristix.com/v2/HL7v2.3/Segments/CM0
type CM0 struct {
	Cm0SetID int `hl7:"POS=2;ATR=sequence"`
	SponsorStudyID EI `hl7:"POS=3"`
	AlternateStudyID []CE `hl7:"POS=4"`
	...
	ContactsTelNumber XTN `hl7:"POS=11"`
