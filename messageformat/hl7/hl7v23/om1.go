...
// https://hl7-definition.caristix.com/v2/HL7v2.3/Segments/OM1
type OM1 struct {
	SequenceNumber *int `hl7:"POS=2"`
	ProducersTestObservationID CE `hl7:"POS=3"`
	...
	OtherTestObservationIdsForTheObservation CE `hl7:"POS=8"`
	...
	Portable string `hl7:"POS=16"`
	ObservationProducingDepartmentSection []CE `hl7:"POS=17"`
	TelephoneNumberOfSection XTN `hl7:"POS=18"`
	NatureOfTestObservation string `hl7:"POS=19"`
	ReportSubheader CE `hl7:"POS=20"`
	ReportDisplayOrder string `hl7:"POS=21"`
	DateTimeStampForAnyChangeInDefAttriForObs time.Time `hl7:"POS=22"`
	EffectiveDateTimeOfChangeInTestProcThatMakeResultsNonComparable time.Time `hl7:"POS=23"`
	...
	OutsideSite []CE `hl7:"POS=28"`
	AddressOfOutsideSite XAD `hl7:"POS=29"`
	PhoneNumberOfOutsideSite XTN `hl7:"POS=30"`
	ConfidentialityCode string `hl7:"POS=31"`
	...
	FactorsThatMayEffectTheObservation string `hl7:"POS=40"`
	TestObservationPerformanceSchedule []string `hl7:"POS=41"`
