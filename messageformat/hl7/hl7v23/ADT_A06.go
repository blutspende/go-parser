...
// https://hl7-definition.caristix.com/v2/HL7v2.3/TriggerEvents/ADT_A06
type ADT_A06 struct {
	...
	DiagnosisRelatedGroup1 DRG `hl7:"TAG=DRG;ATR=optional"`
	ObservationSegment []OBX `hl7:"TAG=OBX;ATR=optional"`
	PatientAllergyInformation []AL1 `hl7:"TAG=AL1;ATR=optional"`
	Diagnosis []DG1 `hl7:"TAG=DG1;ATR=optional"`
	DiagnosisRelatedGroup2 DRG `hl7:"TAG=DRG;ATR=optional"`
	Procedure []ADT_A06_PROCEDURE `hl7:"GROUP;ATR=optional"`
	Guarantor []GT1 `hl7:"TAG=GT1;ATR=optional"`
	Insurance []ADT_A06_INSURANCE `hl7:"GROUP;ATR=optional"`
