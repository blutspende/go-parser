...
type CSU_C09_PATIENT_STUDY_PHASE_STUDY_SCHEDULE struct {
	...
	StudyObservation []CSU_C09_PATIENT_STUDY_PHASE_STUDY_SCHEDULE_STUDY_OBSERVATION `hl7:"GROUP;ATR=optional"`
...
// https://hl7-definition.caristix.com/v2/HL7v2.3/TriggerEvents/CSU_C09
type CSU_C09 struct {
