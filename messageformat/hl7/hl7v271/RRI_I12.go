...
type RRI_I12_PROCEDURE struct {
	...
	Authorization_contact2 RRI_I12_PROCEDURE_AUTHORIZATION_CONTACT2 `hl7:"GROUP;ATR=optional"`
}

// RRI_I12_PROCEDURE_AUTHORIZATION_CONTACT2 - Group struct
type RRI_I12_PROCEDURE_AUTHORIZATION_CONTACT2 struct {
	AuthorizationInformation AUT `hl7:"TAG=AUT"`
	ContactData CTD `hl7:"TAG=CTD;ATR=optional"`
}
...
type RRI_I12_OBSERVATION struct {
	...
	Results_notes []RRI_I12_OBSERVATION_RESULTS_NOTES `hl7:"GROUP;ATR=optional"`
}
...
// https://hl7-definition.caristix.com/v2/HL7v2.7.1/TriggerEvents/RRI_I12
type RRI_I12 struct {
	...
	Authorization_contact RRI_I12_AUTHORIZATION_CONTACT `hl7:"GROUP;ATR=optional"`
	Provider_contact []RRI_I12_PROVIDER_CONTACT `hl7:"GROUP"`
	...
	Patient_visit RRI_I12_PATIENT_VISIT `hl7:"GROUP;ATR=optional"`
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
}
