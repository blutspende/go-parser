...
type OUL_R24_ORDER_SPECIMEN struct {
	...
	Result []OUL_R24_ORDER_SPECIMEN_RESULT `hl7:"GROUP;ATR=optional"`
...
type OUL_R24_ORDER_SPECIMEN_SPECIMEN_OBSERVATION struct {
	ObservationResult OBX `hl7:"TAG=OBX"`
	ParticipationInformation []PRT `hl7:"TAG=PRT;ATR=optional"`
	Container []OUL_R24_ORDER_SPECIMEN_SPECIMEN_OBSERVATION_CONTAINER `hl7:"GROUP;ATR=optional"`
}

// OUL_R24_ORDER_SPECIMEN_SPECIMEN_OBSERVATION_CONTAINER - Group struct
type OUL_R24_ORDER_SPECIMEN_SPECIMEN_OBSERVATION_CONTAINER struct {
	SpecimenContainerDetail SAC `hl7:"TAG=SAC"`
	InventoryDetail INV `hl7:"TAG=INV;ATR=optional"`
}

// OUL_R24_ORDER_SPECIMEN_RESULT - Group struct
type OUL_R24_ORDER_SPECIMEN_RESULT struct {
	ObservationResult OBX `hl7:"TAG=OBX"`
	ParticipationInformation []PRT `hl7:"TAG=PRT;ATR=optional"`
...
// https://hl7-definition.caristix.com/v2/HL7v2.7.1/TriggerEvents/OUL_R24
type OUL_R24 struct {
