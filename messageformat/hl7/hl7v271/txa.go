...
// https://hl7-definition.caristix.com/v2/HL7v2.7.1/Segments/TXA
type TXA struct {
	SetID int `hl7:"POS=2;ATR=sequence"`
	DocumentType CWE `hl7:"POS=3"`
	...
	AuthenticationPersonTimeStampSet []PPN `hl7:"POS=23"`
	DistributedCopiesCodeAndNameOfRecipients []XCN `hl7:"POS=24"`
	FolderAssignment []CWE `hl7:"POS=25"`
	DocumentTitle []string `hl7:"POS=26"`
	AgreedDueDateTime time.Time `hl7:"POS=27"`
}
