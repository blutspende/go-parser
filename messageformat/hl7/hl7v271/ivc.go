...
// IVC - Invoice Segment
// https://hl7-definition.caristix.com/v2/HL7v2.7.1/Segments/IVC
type IVC struct {
	ProviderInvoiceNumber EI `hl7:"POS=2"`
	PayerInvoiceNumber EI `hl7:"POS=3"`
	ContractAgreementNumber EI `hl7:"POS=4"`
	InvoiceControl CWE `hl7:"POS=5"`
	InvoiceReason CWE `hl7:"POS=6"`
	InvoiceType CWE `hl7:"POS=7"`
	...
	BenefitGroup CWE `hl7:"POS=26"`
	ProviderTaxID string `hl7:"POS=27"`
	PayerTaxID string `hl7:"POS=28"`
	ProviderTaxStatus CWE `hl7:"POS=29"`
	PayerTaxStatus CWE `hl7:"POS=30"`
