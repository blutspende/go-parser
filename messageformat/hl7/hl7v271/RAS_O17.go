...
type RAS_O17_PATIENT struct {
	...
	Additional_demographics RAS_O17_PATIENT_ADDITIONAL_DEMOGRAPHICS `hl7:"GROUP;ATR=optional"`
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
	PatientAllergyInformation []AL1 `hl7:"TAG=AL1;ATR=optional"`
	Patient_visit RAS_O17_PATIENT_PATIENT_VISIT `hl7:"GROUP;ATR=optional"`
}

// RAS_O17_PATIENT_ADDITIONAL_DEMOGRAPHICS - Group struct
type RAS_O17_PATIENT_ADDITIONAL_DEMOGRAPHICS struct {
...
type RAS_O17_ORDER struct {
	...
	Order_detail RAS_O17_ORDER_ORDER_DETAIL `hl7:"GROUP;ATR=optional"`
	ParticipationInformation []PRT `hl7:"TAG=PRT;ATR=optional"`
...
type RAS_O17_ORDER_ORDER_DETAIL struct {
	...
	Order_detail_supplement RAS_O17_ORDER_ORDER_DETAIL_ORDER_DETAIL_SUPPLEMENT `hl7:"GROUP;ATR=optional"`
}
...
type RAS_O17_ORDER_ENCODING struct {
	...
	ParticipationInformation []PRT `hl7:"TAG=PRT;ATR=optional"`
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
	Timing_encoded []RAS_O17_ORDER_ENCODING_TIMING_ENCODED `hl7:"GROUP"`
	PharmacyTreatmentRoute []RXR `hl7:"TAG=RXR"`
...
// https://hl7-definition.caristix.com/v2/HL7v2.7.1/TriggerEvents/RAS_O17
type RAS_O17 struct {
