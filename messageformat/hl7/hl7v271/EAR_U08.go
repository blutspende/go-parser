...
type EAR_U08_COMMAND_RESPONSE struct {
	...
	Specimen_container EAR_U08_COMMAND_RESPONSE_SPECIMEN_CONTAINER `hl7:"GROUP;ATR=optional"`
...
// https://hl7-definition.caristix.com/v2/HL7v2.7.1/TriggerEvents/EAR_U08
type EAR_U08 struct {
	MessageHeader MSH `hl7:"TAG=MSH"`
	SoftwareSegment []SFT `hl7:"TAG=SFT;ATR=optional"`
	UserAuthenticationCredentialSegment UAC `hl7:"TAG=UAC;ATR=optional"`
	EquipmentDetail EQU `hl7:"TAG=EQU"`
	Command_response []EAR_U08_COMMAND_RESPONSE `hl7:"GROUP"`
