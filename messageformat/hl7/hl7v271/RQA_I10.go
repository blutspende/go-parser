...
type RQA_I10_PROCEDURE struct {
	...
	Authorization2 RQA_I10_PROCEDURE_AUTHORIZATION2 `hl7:"GROUP;ATR=optional"`
}

// RQA_I10_PROCEDURE_AUTHORIZATION2 - Group struct
type RQA_I10_PROCEDURE_AUTHORIZATION2 struct {
	AuthorizationInformation AUT `hl7:"TAG=AUT"`
	ContactData CTD `hl7:"TAG=CTD;ATR=optional"`
}
...
// https://hl7-definition.caristix.com/v2/HL7v2.7.1/TriggerEvents/RQA_I10
type RQA_I10 struct {
	...
	Guarantor_insurance RQA_I10_GUARANTOR_INSURANCE `hl7:"GROUP;ATR=optional"`
