...
type RGV_O15_PATIENT struct {
	...
	Patient_visit RGV_O15_PATIENT_PATIENT_VISIT `hl7:"GROUP;ATR=optional"`
}
...
type RGV_O15_ORDER struct {
	...
	Order_detail RGV_O15_ORDER_ORDER_DETAIL `hl7:"GROUP;ATR=optional"`
	ParticipationInformation []PRT `hl7:"TAG=PRT;ATR=optional"`
...
type RGV_O15_ORDER_ORDER_DETAIL struct {
	...
	Order_detail_supplement RGV_O15_ORDER_ORDER_DETAIL_ORDER_DETAIL_SUPPLEMENT `hl7:"GROUP;ATR=optional"`
}
...
type RGV_O15_ORDER_ENCODING struct {
	...
	ParticipationInformation []PRT `hl7:"TAG=PRT;ATR=optional"`
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
	Timing_encoded []RGV_O15_ORDER_ENCODING_TIMING_ENCODED `hl7:"GROUP"`
	PharmacyTreatmentRoute []RXR `hl7:"TAG=RXR"`
...
type RGV_O15_ORDER_GIVE struct {
	...
	Timing_give []RGV_O15_ORDER_GIVE_TIMING_GIVE `hl7:"GROUP"`
	PharmacyTreatmentRoute []RXR `hl7:"TAG=RXR"`
	PharmacyTreatmentComponentOrder []RXC `hl7:"TAG=RXC;ATR=optional"`
	Observation []RGV_O15_ORDER_GIVE_OBSERVATION `hl7:"GROUP;ATR=optional"`
}
...
// https://hl7-definition.caristix.com/v2/HL7v2.7.1/TriggerEvents/RGV_O15
type RGV_O15 struct {
