...
type OMN_O07_PATIENT struct {
	...
	Patient_visit OMN_O07_PATIENT_PATIENT_VISIT `hl7:"GROUP;ATR=optional"`
...
type OMN_O07_ORDER struct {
	...
	Timing []OMN_O07_ORDER_TIMING `hl7:"GROUP;ATR=optional"`
...
// OMN_O07_ORDER_TIMING - Group struct
type OMN_O07_ORDER_TIMING struct {
...
// https://hl7-definition.caristix.com/v2/HL7v2.7.1/TriggerEvents/OMN_O07
type OMN_O07 struct {
