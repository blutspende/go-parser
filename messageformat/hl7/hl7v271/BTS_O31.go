...
type BTS_O31_PATIENT struct {
	...
	Patient_visit BTS_O31_PATIENT_PATIENT_VISIT `hl7:"GROUP;ATR=optional"`
}
...
type BTS_O31_ORDER struct {
	...
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
	Product_status []BTS_O31_ORDER_PRODUCT_STATUS `hl7:"GROUP;ATR=optional"`
}
...
// https://hl7-definition.caristix.com/v2/HL7v2.7.1/TriggerEvents/BTS_O31
type BTS_O31 struct {
