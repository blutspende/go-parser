...
// MSH - Message Header
// https://hl7-definition.caristix.com/v2/HL7v2.7.1/Segments/MSH
type MSH struct {
	...
	PrincipalLanguageOfMessage CWE `hl7:"POS=19"`
	AlternateCharacterSetHandlingScheme string `hl7:"POS=20"`
	MessageProfileIdentifier []EI `hl7:"POS=21"`
	SendingResponsibleOrganization XON `hl7:"POS=22"`
	ReceivingResponsibleOrganization XON `hl7:"POS=23"`
	SendingNetworkAddress HD `hl7:"POS=24"`
	ReceivingNetworkAddress HD `hl7:"POS=25"`
}
