...
type PEX_P07_EXPERIENCE struct {
	...
	Pex_observation []PEX_P07_EXPERIENCE_PEX_OBSERVATION `hl7:"GROUP"`
}
...
type PEX_P07_EXPERIENCE_PEX_OBSERVATION struct {
	...
	Pex_cause []PEX_P07_EXPERIENCE_PEX_OBSERVATION_PEX_CAUSE `hl7:"GROUP"`
}
...
type PEX_P07_EXPERIENCE_PEX_OBSERVATION_PEX_CAUSE struct {
	...
	Rx_order PEX_P07_EXPERIENCE_PEX_OBSERVATION_PEX_CAUSE_RX_ORDER `hl7:"GROUP;ATR=optional"`
	Rx_administration []PEX_P07_EXPERIENCE_PEX_OBSERVATION_PEX_CAUSE_RX_ADMINISTRATION `hl7:"GROUP;ATR=optional"`
	ProblemDetails []PRB `hl7:"TAG=PRB;ATR=optional"`
	Observation []PEX_P07_EXPERIENCE_PEX_OBSERVATION_PEX_CAUSE_OBSERVATION `hl7:"GROUP;ATR=optional"`
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
	Associated_person PEX_P07_EXPERIENCE_PEX_OBSERVATION_PEX_CAUSE_ASSOCIATED_PERSON `hl7:"GROUP;ATR=optional"`
...
type PEX_P07_EXPERIENCE_PEX_OBSERVATION_PEX_CAUSE_RX_ORDER struct {
	...
	ParticipationInformation []PRT `hl7:"TAG=PRT;ATR=optional"`
	Timing_qty []PEX_P07_EXPERIENCE_PEX_OBSERVATION_PEX_CAUSE_RX_ORDER_TIMING_QTY `hl7:"GROUP"`
...
// PEX_P07_EXPERIENCE_PEX_OBSERVATION_PEX_CAUSE_OBSERVATION - Group struct
type PEX_P07_EXPERIENCE_PEX_OBSERVATION_PEX_CAUSE_OBSERVATION struct {
...
type PEX_P07_EXPERIENCE_PEX_OBSERVATION_PEX_CAUSE_ASSOCIATED_PERSON struct {
	...
	Associated_rx_order PEX_P07_EXPERIENCE_PEX_OBSERVATION_PEX_CAUSE_ASSOCIATED_PERSON_ASSOCIATED_RX_ORDER `hl7:"GROUP;ATR=optional"`
	Associated_rx_admin []PEX_P07_EXPERIENCE_PEX_OBSERVATION_PEX_CAUSE_ASSOCIATED_PERSON_ASSOCIATED_RX_ADMIN `hl7:"GROUP;ATR=optional"`
	ProblemDetails []PRB `hl7:"TAG=PRB;ATR=optional"`
	Associated_observation []PEX_P07_EXPERIENCE_PEX_OBSERVATION_PEX_CAUSE_ASSOCIATED_PERSON_ASSOCIATED_OBSERVATION `hl7:"GROUP;ATR=optional"`
}
...
type PEX_P07_EXPERIENCE_PEX_OBSERVATION_PEX_CAUSE_ASSOCIATED_PERSON_ASSOCIATED_RX_ORDER struct {
	PharmacyTreatmentEncodedOrder RXE `hl7:"TAG=RXE"`
	ParticipationInformation []PRT `hl7:"TAG=PRT;ATR=optional"`
	Nk1_timing_qty []PEX_P07_EXPERIENCE_PEX_OBSERVATION_PEX_CAUSE_ASSOCIATED_PERSON_ASSOCIATED_RX_ORDER_NK1_TIMING_QTY `hl7:"GROUP"`
	PharmacyTreatmentRoute []RXR `hl7:"TAG=RXR;ATR=optional"`
}
...
// PEX_P07_EXPERIENCE_PEX_OBSERVATION_PEX_CAUSE_ASSOCIATED_PERSON_ASSOCIATED_OBSERVATION - Group struct
type PEX_P07_EXPERIENCE_PEX_OBSERVATION_PEX_CAUSE_ASSOCIATED_PERSON_ASSOCIATED_OBSERVATION struct {
	ObservationResult OBX `hl7:"TAG=OBX"`
	ParticipationInformation []PRT `hl7:"TAG=PRT;ATR=optional"`
}
...
// https://hl7-definition.caristix.com/v2/HL7v2.7.1/TriggerEvents/PEX_P07
type PEX_P07 struct {
