...
type SIU_S20_RESOURCES struct {
	...
	General_resource []SIU_S20_RESOURCES_GENERAL_RESOURCE `hl7:"GROUP;ATR=optional"`
	Location_resource []SIU_S20_RESOURCES_LOCATION_RESOURCE `hl7:"GROUP;ATR=optional"`
	Personnel_resource []SIU_S20_RESOURCES_PERSONNEL_RESOURCE `hl7:"GROUP;ATR=optional"`
}
...
// https://hl7-definition.caristix.com/v2/HL7v2.7.1/TriggerEvents/SIU_S20
type SIU_S20 struct {
