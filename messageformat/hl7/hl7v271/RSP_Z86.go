...
type RSP_Z86_QUERY_RESPONSE struct {
	...
	Common_order []RSP_Z86_QUERY_RESPONSE_COMMON_ORDER `hl7:"GROUP"`
}
...
type RSP_Z86_QUERY_RESPONSE_COMMON_ORDER struct {
	...
	Order_detail RSP_Z86_QUERY_RESPONSE_COMMON_ORDER_ORDER_DETAIL `hl7:"GROUP;ATR=optional"`
	Encoded_order RSP_Z86_QUERY_RESPONSE_COMMON_ORDER_ENCODED_ORDER `hl7:"GROUP;ATR=optional"`
...
type RSP_Z86_QUERY_RESPONSE_COMMON_ORDER_ENCODED_ORDER struct {
	...
	Timing_encoded []RSP_Z86_QUERY_RESPONSE_COMMON_ORDER_ENCODED_ORDER_TIMING_ENCODED `hl7:"GROUP;ATR=optional"`
	PharmacyTreatmentRoute []RXR `hl7:"TAG=RXR"`
	PharmacyTreatmentComponentOrder []RXC `hl7:"TAG=RXC;ATR=optional"`
}
...
// https://hl7-definition.caristix.com/v2/HL7v2.7.1/TriggerEvents/RSP_Z86
type RSP_Z86 struct {
	...
	Query_response []RSP_Z86_QUERY_RESPONSE `hl7:"GROUP"`
