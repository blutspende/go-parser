...
type CQU_I19_APPOINTMENT_HISTORY_RESOURCES_RESOURCE_DETAIL struct {
	Resource_object CQU_I19_APPOINTMENT_HISTORY_RESOURCES_RESOURCE_DETAIL_RESOURCE_OBJECT `hl7:"GROUP;ATR=optional"`
...
type CQU_I19_PROBLEM_ROLE_PROBLEM struct {
	Role_problem_object CQU_I19_PROBLEM_ROLE_PROBLEM_ROLE_PROBLEM_OBJECT `hl7:"GROUP;ATR=optional"`
	Variance []VAR `hl7:"TAG=VAR;ATR=optional"`
}
...
type CQU_I19_GOAL_ROLE_GOAL struct {
	Role_goal_object CQU_I19_GOAL_ROLE_GOAL_ROLE_GOAL_OBJECT `hl7:"GROUP;ATR=optional"`
	Variance []VAR `hl7:"TAG=VAR;ATR=optional"`
}
...
type CQU_I19_PATHWAY_ROLE_PATHWAY struct {
	Role_pathway_object CQU_I19_PATHWAY_ROLE_PATHWAY_ROLE_PATHWAY_OBJECT `hl7:"GROUP;ATR=optional"`
	Variance []VAR `hl7:"TAG=VAR;ATR=optional"`
}
...
// https://hl7-definition.caristix.com/v2/HL7v2.7.1/TriggerEvents/CQU_I19
type CQU_I19 struct {
