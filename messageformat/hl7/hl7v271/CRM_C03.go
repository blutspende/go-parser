...
type CRM_C03_PATIENT struct {
	...
	Patient_visit CRM_C03_PATIENT_PATIENT_VISIT `hl7:"GROUP;ATR=optional"`
	ClinicalStudyRegistration CSR `hl7:"TAG=CSR"`
	ClinicalStudyPhase []CSP `hl7:"TAG=CSP;ATR=optional"`
}

// CRM_C03_PATIENT_PATIENT_VISIT - Group struct
type CRM_C03_PATIENT_PATIENT_VISIT struct {
	PatientVisit PV1 `hl7:"TAG=PV1"`
	ParticipationInformation []PRT `hl7:"TAG=PRT;ATR=optional"`
}

// CRM_C03 - Correct/update registration information
// https://hl7-definition.caristix.com/v2/HL7v2.7.1/TriggerEvents/CRM_C03
type CRM_C03 struct {
