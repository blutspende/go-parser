...
type PRR_PC5_PATIENT struct {
	...
	Patient_visit PRR_PC5_PATIENT_PATIENT_VISIT `hl7:"GROUP;ATR=optional"`
...
type PRR_PC5_PATIENT_PROBLEM struct {
	...
	Problem_role []PRR_PC5_PATIENT_PROBLEM_PROBLEM_ROLE `hl7:"GROUP;ATR=optional"`
	Problem_pathway []PRR_PC5_PATIENT_PROBLEM_PROBLEM_PATHWAY `hl7:"GROUP;ATR=optional"`
	Problem_observation []PRR_PC5_PATIENT_PROBLEM_PROBLEM_OBSERVATION `hl7:"GROUP;ATR=optional"`
...
type PRR_PC5_PATIENT_PROBLEM_GOAL struct {
	...
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
	Variance []VAR `hl7:"TAG=VAR;ATR=optional"`
	Goal_role []PRR_PC5_PATIENT_PROBLEM_GOAL_GOAL_ROLE `hl7:"GROUP;ATR=optional"`
	Goal_observation []PRR_PC5_PATIENT_PROBLEM_GOAL_GOAL_OBSERVATION `hl7:"GROUP;ATR=optional"`
}
...
type PRR_PC5_PATIENT_PROBLEM_ORDER struct {
	...
	Order_detail PRR_PC5_PATIENT_PROBLEM_ORDER_ORDER_DETAIL `hl7:"GROUP;ATR=optional"`
}
...
type PRR_PC5_PATIENT_PROBLEM_ORDER_ORDER_DETAIL struct {
	...
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
	Variance []VAR `hl7:"TAG=VAR;ATR=optional"`
	Order_observation []PRR_PC5_PATIENT_PROBLEM_ORDER_ORDER_DETAIL_ORDER_OBSERVATION `hl7:"GROUP;ATR=optional"`
}
...
// https://hl7-definition.caristix.com/v2/HL7v2.7.1/TriggerEvents/PRR_PC5
type PRR_PC5 struct {
