...
// https://hl7-definition.caristix.com/v2/HL7v2.7.1/Segments/PV2
type PV2 struct {
	...
	RecurringServiceCode CWE `hl7:"POS=32"`
	...
	LivingWillCode CWE `hl7:"POS=44"`
	OrganDonorCode CWE `hl7:"POS=45"`
	...
	NotifyClergyCode []CWE `hl7:"POS=50"`
