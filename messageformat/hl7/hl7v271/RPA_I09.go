...
// RPA_I09_AUTHORIZATION_1 - Group struct
type RPA_I09_AUTHORIZATION_1 struct {
...
type RPA_I09_PROCEDURE struct {
	...
	Authorization2 RPA_I09_PROCEDURE_AUTHORIZATION_2 `hl7:"GROUP;ATR=optional"`
}

// RPA_I09_PROCEDURE_AUTHORIZATION_2 - Group struct
type RPA_I09_PROCEDURE_AUTHORIZATION_2 struct {
	AuthorizationInformation AUT `hl7:"TAG=AUT"`
	ContactData CTD `hl7:"TAG=CTD;ATR=optional"`
}
...
// https://hl7-definition.caristix.com/v2/HL7v2.7.1/TriggerEvents/RPA_I09
type RPA_I09 struct {
	...
	Authorization1 RPA_I09_AUTHORIZATION_1 `hl7:"GROUP;ATR=optional"`
