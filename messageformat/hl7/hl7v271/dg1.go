...
// DG1 - Diagnosis
// https://hl7-definition.caristix.com/v2/HL7v2.7.1/Segments/DG1
type DG1 struct {
	SetID int `hl7:"POS=2;ATR=sequence"`
	DiagnosisCodeDg1 CWE `hl7:"POS=4"`
	DiagnosisDateTime time.Time `hl7:"POS=6"`
	DiagnosisType CWE `hl7:"POS=7"`
	DiagnosisPriority *int `hl7:"POS=16"`
	DiagnosingClinician []XCN `hl7:"POS=17"`
	DiagnosisClassification CWE `hl7:"POS=18"`
	...
	DrgDiagnosisDeterminationStatus CWE `hl7:"POS=26"`
	PresentOnAdmissionPoaIndicator CWE `hl7:"POS=27"`
}
