...
// https://hl7-definition.caristix.com/v2/HL7v2.7.1/Segments/STF
type STF struct {
	PrimaryKeyValueStf CWE `hl7:"POS=2"`
	StaffIdentifierList []CX `hl7:"POS=3"`
	StaffName []XPN `hl7:"POS=4"`
	StaffType []CWE `hl7:"POS=5"`
	AdministrativeSex CWE `hl7:"POS=6"`
	DateTimeOfBirth time.Time `hl7:"POS=7"`
	ActiveInactiveFlag string `hl7:"POS=8"`
	Department []CWE `hl7:"POS=9"`
	HospitalServiceStf []CWE `hl7:"POS=10"`
	...
	BackupPersonID []CWE `hl7:"POS=15"`
	EMailAddress []string `hl7:"POS=16"`
	PreferredMethodOfContact CWE `hl7:"POS=17"`
	MaritalStatus CWE `hl7:"POS=18"`
	JobTitle string `hl7:"POS=19"`
	JobCodeClass JCC `hl7:"POS=20"`
	EmploymentStatusCode CWE `hl7:"POS=21"`
	...
	DateTimeOfDeath time.Time `hl7:"POS=32"`
	...
	GenericResourceTypeOrCategory []CWE `hl7:"POS=40"`
	Religion CWE `hl7:"POS=41"`
	Signature ED `hl7:"POS=42"`
}
