...
type DFT_P11_COMMON_ORDER struct {
	...
	Timing_quantity []DFT_P11_COMMON_ORDER_TIMING_QUANTITY `hl7:"GROUP;ATR=optional"`
...
type DFT_P11_FINANCIAL struct {
	...
	Financial_procedure []DFT_P11_FINANCIAL_FINANCIAL_PROCEDURE `hl7:"GROUP;ATR=optional"`
	Financial_common_order []DFT_P11_FINANCIAL_FINANCIAL_COMMON_ORDER `hl7:"GROUP;ATR=optional"`
	Diagnosis []DG1 `hl7:"TAG=DG1;ATR=optional"`
	DiagnosisRelatedGroup DRG `hl7:"TAG=DRG;ATR=optional"`
	Guarantor []GT1 `hl7:"TAG=GT1;ATR=optional"`
	Financial_insurance []DFT_P11_FINANCIAL_FINANCIAL_INSURANCE `hl7:"GROUP;ATR=optional"`
}
...
type DFT_P11_FINANCIAL_FINANCIAL_COMMON_ORDER struct {
	CommonOrder ORC `hl7:"TAG=ORC;ATR=optional"`
	Financial_timing_quantity []DFT_P11_FINANCIAL_FINANCIAL_COMMON_ORDER_FINANCIAL_TIMING_QUANTITY `hl7:"GROUP;ATR=optional"`
	Financial_order DFT_P11_FINANCIAL_FINANCIAL_COMMON_ORDER_FINANCIAL_ORDER `hl7:"GROUP;ATR=optional"`
	Financial_observation []DFT_P11_FINANCIAL_FINANCIAL_COMMON_ORDER_FINANCIAL_OBSERVATION `hl7:"GROUP;ATR=optional"`
}
...
// https://hl7-definition.caristix.com/v2/HL7v2.7.1/TriggerEvents/DFT_P11
type DFT_P11 struct {
	...
	Common_order []DFT_P11_COMMON_ORDER `hl7:"GROUP;ATR=optional"`
	Diagnosis []DG1 `hl7:"TAG=DG1;ATR=optional"`
	DiagnosisRelatedGroup DRG `hl7:"TAG=DRG;ATR=optional"`
	Guarantor []GT1 `hl7:"TAG=GT1;ATR=optional"`
