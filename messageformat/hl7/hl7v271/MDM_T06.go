...
// MDM_T06_OBSERVATION - Group struct
...
// https://hl7-definition.caristix.com/v2/HL7v2.7.1/TriggerEvents/MDM_T06
type MDM_T06 struct {
	...
	Common_order []MDM_T06_COMMON_ORDER `hl7:"GROUP;ATR=optional"`
	TranscriptionDocumentHeader TXA `hl7:"TAG=TXA"`
	ConsentSegment []CON `hl7:"TAG=CON;ATR=optional"`
	Observation []MDM_T06_OBSERVATION `hl7:"GROUP"`
}
