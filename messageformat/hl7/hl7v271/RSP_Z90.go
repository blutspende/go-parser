...
type RSP_Z90_QUERY_RESPONSE struct {
	...
	Common_order []RSP_Z90_QUERY_RESPONSE_COMMON_ORDER `hl7:"GROUP"`
...
// https://hl7-definition.caristix.com/v2/HL7v2.7.1/TriggerEvents/RSP_Z90
type RSP_Z90 struct {
	...
	Query_response []RSP_Z90_QUERY_RESPONSE `hl7:"GROUP"`
