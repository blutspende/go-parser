...
type PPT_PCL_PATIENT struct {
	...
	Patient_visit PPT_PCL_PATIENT_PATIENT_VISIT `hl7:"GROUP;ATR=optional"`
...
type PPT_PCL_PATIENT_PATHWAY struct {
	...
	Pathway_role []PPT_PCL_PATIENT_PATHWAY_PATHWAY_ROLE `hl7:"GROUP;ATR=optional"`
...
type PPT_PCL_PATIENT_PATHWAY_GOAL struct {
	...
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
	Variance []VAR `hl7:"TAG=VAR;ATR=optional"`
	Goal_role []PPT_PCL_PATIENT_PATHWAY_GOAL_GOAL_ROLE `hl7:"GROUP;ATR=optional"`
	Goal_observation []PPT_PCL_PATIENT_PATHWAY_GOAL_GOAL_OBSERVATION `hl7:"GROUP;ATR=optional"`
...
type PPT_PCL_PATIENT_PATHWAY_GOAL_PROBLEM struct {
	...
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
	Variance []VAR `hl7:"TAG=VAR;ATR=optional"`
	Problem_role []PPT_PCL_PATIENT_PATHWAY_GOAL_PROBLEM_PROBLEM_ROLE `hl7:"GROUP;ATR=optional"`
	Problem_observation []PPT_PCL_PATIENT_PATHWAY_GOAL_PROBLEM_PROBLEM_OBSERVATION `hl7:"GROUP;ATR=optional"`
}
...
type PPT_PCL_PATIENT_PATHWAY_GOAL_ORDER struct {
	...
	Order_detail PPT_PCL_PATIENT_PATHWAY_GOAL_ORDER_ORDER_DETAIL `hl7:"GROUP;ATR=optional"`
}
...
type PPT_PCL_PATIENT_PATHWAY_GOAL_ORDER_ORDER_DETAIL struct {
	...
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
	Variance []VAR `hl7:"TAG=VAR;ATR=optional"`
	Order_observation []PPT_PCL_PATIENT_PATHWAY_GOAL_ORDER_ORDER_DETAIL_ORDER_OBSERVATION `hl7:"GROUP;ATR=optional"`
}
...
// https://hl7-definition.caristix.com/v2/HL7v2.7.1/TriggerEvents/PPT_PCL
type PPT_PCL struct {
