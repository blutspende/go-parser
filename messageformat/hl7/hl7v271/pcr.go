...
// https://hl7-definition.caristix.com/v2/HL7v2.7.1/Segments/PCR
type PCR struct {
	ImplicatedProduct CWE `hl7:"POS=2"`
	GenericProduct string `hl7:"POS=3"`
	ProductClass CWE `hl7:"POS=4"`
	...
	SingleUseDevice CWE `hl7:"POS=10"`
	IndicationForProductUse CWE `hl7:"POS=11"`
	ProductProblem CWE `hl7:"POS=12"`
	ProductSerialLotNumber []string `hl7:"POS=13"`
	ProductAvailableForInspection CWE `hl7:"POS=14"`
	ProductEvaluationPerformed CWE `hl7:"POS=15"`
	ProductEvaluationStatus CWE `hl7:"POS=16"`
	ProductEvaluationResults CWE `hl7:"POS=17"`
