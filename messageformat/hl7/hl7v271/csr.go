...
// https://hl7-definition.caristix.com/v2/HL7v2.7.1/Segments/CSR
type CSR struct {
	SponsorStudyID EI `hl7:"POS=2"`
	AlternateStudyID EI `hl7:"POS=3"`
	InstitutionRegisteringThePatient CWE `hl7:"POS=4"`
	...
	PatientStudyEligibilityStatus CWE `hl7:"POS=11"`
	StudyRandomizationDateTime []time.Time `hl7:"POS=12"`
	RandomizedStudyArm []CWE `hl7:"POS=13"`
	StratumForStudyRandomization []CWE `hl7:"POS=14"`
	PatientEvaluabilityStatus CWE `hl7:"POS=15"`
	DateTimeEndedStudy time.Time `hl7:"POS=16"`
	ReasonEndedStudy CWE `hl7:"POS=17"`
}
