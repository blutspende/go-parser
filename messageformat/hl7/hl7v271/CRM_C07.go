...
type CRM_C07_PATIENT struct {
	...
	Patient_visit CRM_C07_PATIENT_PATIENT_VISIT `hl7:"GROUP;ATR=optional"`
	ClinicalStudyRegistration CSR `hl7:"TAG=CSR"`
	ClinicalStudyPhase []CSP `hl7:"TAG=CSP;ATR=optional"`
}

// CRM_C07_PATIENT_PATIENT_VISIT - Group struct
type CRM_C07_PATIENT_PATIENT_VISIT struct {
	PatientVisit PV1 `hl7:"TAG=PV1"`
	ParticipationInformation []PRT `hl7:"TAG=PRT;ATR=optional"`
}

// CRM_C07 - Correct/update phase information
// https://hl7-definition.caristix.com/v2/HL7v2.7.1/TriggerEvents/CRM_C07
type CRM_C07 struct {
