...
type REF_I14_PROCEDURE struct {
	...
	Authorization_contact2 REF_I14_PROCEDURE_AUTHORIZATION_CONTACT2 `hl7:"GROUP;ATR=optional"`
}

// REF_I14_PROCEDURE_AUTHORIZATION_CONTACT2 - Group struct
type REF_I14_PROCEDURE_AUTHORIZATION_CONTACT2 struct {
	AuthorizationInformation AUT `hl7:"TAG=AUT"`
	ContactData CTD `hl7:"TAG=CTD;ATR=optional"`
}
...
type REF_I14_OBSERVATION struct {
	...
	Results_notes []REF_I14_OBSERVATION_RESULTS_NOTES `hl7:"GROUP;ATR=optional"`
}
...
// https://hl7-definition.caristix.com/v2/HL7v2.7.1/TriggerEvents/REF_I14
type REF_I14 struct {
	MessageHeader MSH `hl7:"TAG=MSH"`
	SoftwareSegment []SFT `hl7:"TAG=SFT;ATR=optional"`
	UserAuthenticationCredentialSegment UAC `hl7:"TAG=UAC;ATR=optional"`
	ReferralInformation RF1 `hl7:"TAG=RF1;ATR=optional"`
	Authorization_contact REF_I14_AUTHORIZATION_CONTACT `hl7:"GROUP;ATR=optional"`
	Provider_contact []REF_I14_PROVIDER_CONTACT `hl7:"GROUP"`
	...
	Patient_visit REF_I14_PATIENT_VISIT `hl7:"GROUP;ATR=optional"`
	NotesAndComments []NTE `hl7:"TAG=NTE;ATR=optional"`
}
