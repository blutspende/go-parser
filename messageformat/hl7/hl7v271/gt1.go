...
// GT1 - Guarantor
// https://hl7-definition.caristix.com/v2/HL7v2.7.1/Segments/GT1
type GT1 struct {
	...
	GuarantorAdministrativeSex CWE `hl7:"POS=10"`
	GuarantorType CWE `hl7:"POS=11"`
	GuarantorRelationship CWE `hl7:"POS=12"`
