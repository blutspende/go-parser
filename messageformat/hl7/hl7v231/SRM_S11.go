...
type SRM_S11_RESOURCES struct {
	...
	GeneralResource []SRM_S11_RESOURCES_GENERAL_RESOURCE `hl7:"GROUP;ATR=optional"`
	LocationResource []SRM_S11_RESOURCES_LOCATION_RESOURCE `hl7:"GROUP;ATR=optional"`
	PersonnelResource []SRM_S11_RESOURCES_PERSONNEL_RESOURCE `hl7:"GROUP;ATR=optional"`
}
...
// https://hl7-definition.caristix.com/v2/HL7v2.3.1/TriggerEvents/SRM_S11
type SRM_S11 struct {
