...
// MFR_M03_MF_QUERY - Group struct
type MFR_M03_MF_QUERY struct {
	MasterFileEntrySegment MFE `hl7:"TAG=MFE"`
}

// MFR_M03 - Master Files Response - Test/Observation
// https://hl7-definition.caristix.com/v2/HL7v2.3.1/TriggerEvents/MFR_M03
type MFR_M03 struct {
	...
	MfQuery []MFR_M03_MF_QUERY `hl7:"GROUP"`
