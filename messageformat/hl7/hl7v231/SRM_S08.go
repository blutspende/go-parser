...
type SRM_S08_RESOURCES struct {
	...
	GeneralResource []SRM_S08_RESOURCES_GENERAL_RESOURCE `hl7:"GROUP;ATR=optional"`
	LocationResource []SRM_S08_RESOURCES_LOCATION_RESOURCE `hl7:"GROUP;ATR=optional"`
	PersonnelResource []SRM_S08_RESOURCES_PERSONNEL_RESOURCE `hl7:"GROUP;ATR=optional"`
}
...
// https://hl7-definition.caristix.com/v2/HL7v2.3.1/TriggerEvents/SRM_S08
type SRM_S08 struct {
