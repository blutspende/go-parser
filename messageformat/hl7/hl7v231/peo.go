...
// https://hl7-definition.caristix.com/v2/HL7v2.3.1/Segments/PEO
type PEO struct {
	EventIdentifiersUsed []CE `hl7:"POS=2"`
	EventSymptomDiagnosisCode []CE `hl7:"POS=3"`
	...
	EventFromOriginalReporter []string `hl7:"POS=15"`
